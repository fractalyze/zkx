...
bool ParseStringFlag(std::string_view arg, std::string_view flag,
...
bool ParseInt32Flag(std::string_view arg, std::string_view flag,
...
bool ParseInt64Flag(std::string_view arg, std::string_view flag,
...
bool ParseBoolFlag(std::string_view arg, std::string_view flag,
...
bool ParseFloatFlag(std::string_view arg, std::string_view flag,
...
// static
bool Flags::Parse(int* argc, char** argv, const std::vector<Flag>& flag_list) {
  bool result = true;
