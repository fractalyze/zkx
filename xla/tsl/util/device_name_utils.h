...
class DeviceNameUtils {
 public:
  ...
  static bool ParseFullOrLocalName(std::string_view fullname,
                                   ParsedName* parsed);
  ...
  // "/device:cpu:0"
  static bool ParseFullName(std::string_view fullname, ParsedName* parsed);
  ...
  static absl::Status CanonicalizeDeviceName(std::string_view fullname,
  ...
  // same address space.
  static bool IsSameAddressSpace(std::string_view src, std::string_view dst);
  ...
  static bool SplitDeviceName(std::string_view name, std::string* task,
                              std::string* device);
  ...
  static bool CompareFullNames(std::string_view a, std::string_view b) {
    ParsedName parsed_a;
    ParsedName parsed_b;
