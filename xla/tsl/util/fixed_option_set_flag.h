...
#ifndef ZKX_TSL_UTIL_FIXED_OPTION_SET_FLAG_H_
#define ZKX_TSL_UTIL_FIXED_OPTION_SET_FLAG_H_
...
class FixedOptionSetFlagParser {
 public:
  ...
  [[nodiscard]] bool Parse(std::string_view text, T* value,
...
#endif  // ZKX_TSL_UTIL_FIXED_OPTION_SET_FLAG_H_
