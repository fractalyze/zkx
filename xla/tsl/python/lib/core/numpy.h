...
// We import_array in the ZKX init function only.
#define PY_ARRAY_UNIQUE_SYMBOL _zkx_numpy_api
#ifndef ZKX_IMPORT_NUMPY
#define NO_IMPORT_ARRAY
#endif

// Prevent linking error with numpy>=2.1.0
// error: undefined hidden symbol: _zkx_numpy_apiPyArray_RUNTIME_VERSION
