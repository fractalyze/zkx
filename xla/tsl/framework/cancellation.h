...
class CancellationManager {
 ...
 private:
  ...
  bool is_removed_from_parent_ ABSL_GUARDED_BY(parent_->mu_) = false;
  ...
  CancellationManager* prev_sibling_ ABSL_GUARDED_BY(parent_->mu_) =
      nullptr;  // Not owned.
  CancellationManager* next_sibling_ ABSL_GUARDED_BY(parent_->mu_) =
      nullptr;  // Not owned.
