// RUN: emitters_opt %s -split-input-file -zkx-lower-tensors -zkx-merge-pointers | FileCheck %s

module {
  func.func private @tensorargs(%arg0: tensor<43xf32> {zkx.slice_index = 0},
                        %arg1: tensor<43xf32> {zkx.slice_index = 1, zkx.invariant},
                        %arg2: tensor<43xf32> {zkx.slice_index = 0},
                        %arg3: index) -> f32 {
  ...
  func.func @tensorcall(%arg0: tensor<43xf32> {zkx.slice_index = 0},
                        %arg1: tensor<43xf32> {zkx.slice_index = 1, zkx.invariant},
                        %arg2: tensor<43xf32> {zkx.slice_index = 0},
                        %arg3: index) -> f32 {
...
// CHECK-SAME:   %[[ARG1:.*]]: !llvm.ptr {llvm.noalias, zkx.invariant},
