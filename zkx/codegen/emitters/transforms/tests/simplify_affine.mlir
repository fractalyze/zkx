// RUN: emitters_opt --allow-unregistered-dialect %s -split-input-file -zkx-simplify-affine | FileCheck %s

func.func @op_and_for_ranges(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr) {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %c4 = arith.constant 4 : index
  %0 = gpu.thread_id  x {zkx.range = [0 : index, 127 : index]}
  %1 = gpu.block_id  x {zkx.range = [0 : index, 3071 : index]}
...
func.func @arg_ranges(%arg0: index {zkx.range = [0 : index, 42 : index]}, %arg1: index {zkx.range = [0 : index, 1000 : index]}) -> index {
...
func.func @cant_lower(%arg0: index {zkx.range = [-10 : index, 42 : index]}, %arg1: index {zkx.range = [0 : index, 1000 : index]}) -> index {
  %0 = affine.apply affine_map<()[s0, s1] -> (s0 floordiv 100 + s1 floordiv 100)>()[%arg0, %arg1]
  return %0 : index
}
...
func.func @cant_lower(%arg0: index, %arg1: index) -> (index, index) {
  %0:2 = zkx.apply_indexing
    #zkx.indexing_map<"()[s0, s1] -> (s0 floordiv 100 + s1 floordiv 100, s0 + s1),"
