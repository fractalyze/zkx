...
#include "zkx/codegen/emitters/ir/zkx_attrs.cc.inc"
#include "zkx/codegen/emitters/ir/zkx_enums.cc.inc"

namespace zkx {
namespace {

struct ZkxInlinerInterface : public mlir::DialectInlinerInterface {
  ...
  bool isLegalToInline(mlir::Operation* op, mlir::Region* dest,
    ...
    // We allow any op from the zkx dialect to be inlined.
    return true;
  }
...
struct ZkxOpAsmDialectInterface : public mlir::OpAsmDialectInterface {
...
#include "zkx/codegen/emitters/ir/zkx_attrs.cc.inc"  // NOLINT(build/include)
      >();
  addInterfaces<ZkxInlinerInterface, ZkxOpAsmDialectInterface>();
}
