...
#ifndef ZKX_CODEGEN_EMITTER_LOC_OP_BUILDER_H_
#define ZKX_CODEGEN_EMITTER_LOC_OP_BUILDER_H_
...
class EmitterLocOpBuilder : public mlir::ImplicitLocOpBuilder {
 public:
  ...
  static std::string FormatTritonIrWithAnnotations(std::string_view mlir_ir);
...
#endif  // ZKX_CODEGEN_EMITTER_LOC_OP_BUILDER_H_
