...
#ifndef ZKX_CODEGEN_LLVM_IR_KERNEL_SOURCE_H_
#define ZKX_CODEGEN_LLVM_IR_KERNEL_SOURCE_H_
...
#include "zkx/codegen/kernel_source.h"

namespace zkx {

// ZKX kernel compiled to LLVM IR. Depending on the concrete kernel emitter
...
#endif  // ZKX_CODEGEN_LLVM_IR_KERNEL_SOURCE_H_
