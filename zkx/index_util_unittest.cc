...
TEST(IndexUtilTest, VectorIndexing) {
  ...
  Shape vector_shape = ShapeUtil::MakeShape(U32, {100});
  EXPECT_EQ(42,
...
TEST(IndexUtilTest, MatrixIndexingRowMajor) {
  ...
  Shape matrix_shape_01 = ShapeUtil::MakeShape(U32, {10, 20});
...
TEST(IndexUtilTest, MatrixIndexingColumnMajor) {
  ...
  Shape matrix_shape_10 = ShapeUtil::MakeShape(U32, {10, 20});
...
TEST(IndexUtilTest, ThreeDArrayIndexing210) {
  ...
  Shape shape_210 = ShapeUtil::MakeShape(U32, {10, 20, 30});
...
TEST(IndexUtilTest, ThreeDArrayIndexing120) {
  // Set layout to [1, 2, 0]
  Shape shape_120 = ShapeUtil::MakeShape(U32, {10, 20, 30});
...
TEST(IndexUtilTest, FourDArrayIndexing3210) {
  ...
  Shape shape_3210 = ShapeUtil::MakeShape(U32, {10, 20, 30, 40});
...
TEST(IndexUtilTest, LinearToMultiToLinear) {
  ...
  for (auto minor_to_major_order : minor_to_major_orders) {
    Shape shape = ShapeUtil::MakeShape(U32, {10, 20, 30, 40, 30, 20, 10});
