...
#ifndef ZKX_SHAPE_TREE_H_
#define ZKX_SHAPE_TREE_H_
...
// ZKX shape and holds a value of type T for each subshape (i.e. tuple or array)
...
class ShapeTree {
 ...
 private:
  ...
  // The ZKX shape mirrored in this ShapeTree. This is either
