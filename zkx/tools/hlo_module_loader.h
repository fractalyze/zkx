...
#ifndef ZKX_TOOLS_HLO_MODULE_LOADER_H_
#define ZKX_TOOLS_HLO_MODULE_LOADER_H_
...
// 1) A binary of text proto file, the proto should be in zkx.HloProto type. It
...
#endif  // ZKX_TOOLS_HLO_MODULE_LOADER_H_
