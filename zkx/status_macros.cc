...
void LogError(const absl::Status& status, const char* filename, int line,
              absl::LogSeverity log_severity, bool should_log_stack_trace) {
  std::string stack_trace;
  if (should_log_stack_trace) {
    // TODO(chokobole): Uncomment this. Dependency: CurrentStackTrace()
...
// false).
absl::Status MakeError(const char* filename, int line, absl::StatusCode code,
