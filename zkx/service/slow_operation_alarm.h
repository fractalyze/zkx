...
#ifndef ZKX_SERVICE_SLOW_OPERATION_ALARM_H_
#define ZKX_SERVICE_SLOW_OPERATION_ALARM_H_
...
class SlowOperationAlarm {
 ...
 private:
  ...
  std::atomic<int64_t>* counter_;  // not owned
...
#endif  // ZKX_SERVICE_SLOW_OPERATION_ALARM_H_
