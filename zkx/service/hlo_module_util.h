...
#ifndef ZKX_SERVICE_HLO_MODULE_UTIL_H_
#define ZKX_SERVICE_HLO_MODULE_UTIL_H_
...
// If `execution_options` does not set num_replicas, `default_num_replicas` is
// used. `num_threads` is optional; if not given, `intra_op_parallelism_threads`
// not set. `aot_options` is optional; if not given a default is used.
