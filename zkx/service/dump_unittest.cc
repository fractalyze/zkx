...
TEST(DumpHloIfEnabled, LargeConstantElided) {
  ...
  options.set_zkx_dump_to(dump_dir);
  options.set_zkx_dump_hlo_as_text(true);
  options.set_zkx_dump_large_constants(false);
...
TEST(DumpHloIfEnabled, LargeConstantPrinted) {
  ...
  options.set_zkx_dump_to(dump_dir);
  options.set_zkx_dump_hlo_as_text(true);
  options.set_zkx_dump_large_constants(true);
  config.set_debug_options(options);
  const char* kModuleStr = R"(
    HloModule m
    test {
...
TEST(DumpTest, NoDumpingToFileWhenNotEnabled) {
  ...
  options.set_zkx_enable_dumping(false);
  options.set_zkx_dump_to(filename);
...
TEST(DumpTest, DumpingToFileWorksWhenEnabled) {
  ...
  std::string contents = "hello";
  DebugOptions options;
  options.set_zkx_dump_to(tsl::testing::TmpDir());
  options.set_zkx_enable_dumping(true);
...
TEST(DumpTest, DumpFdoProfileToFileWhenEnabled) {
  ...
  options.set_zkx_dump_to(dump_dir);
  options.set_zkx_gpu_experimental_dump_fdo_profiles(true);
  config.set_debug_options(options);
  const char* kModuleStr = R"(
    HloModule m
    test {
...
TEST(DumpTest, DumpHloUnoptimizedSnapshot) {
  ...
  *hlo_snapshot.add_partitions() = HloInputs();
  ...
  options.set_zkx_dump_to(tsl::testing::TmpDir());
  options.set_zkx_dump_hlo_as_text(true);
  options.set_zkx_gpu_dump_hlo_unoptimized_snapshots(true);
  config.set_debug_options(options);
