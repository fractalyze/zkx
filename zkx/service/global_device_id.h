...
#ifndef ZKX_SERVICE_GLOBAL_DEVICE_ID_H_
#define ZKX_SERVICE_GLOBAL_DEVICE_ID_H_
...
// system. ZKX doesn't have a strong opinion about what global numbering scheme
...
std::string GlobalDeviceIdsToString(absl::Span<const GlobalDeviceId> ids);

}  // namespace zkx

#endif  // ZKX_SERVICE_GLOBAL_DEVICE_ID_H_
