...
#ifndef ZKX_SERVICE_LAYOUT_ASSIGNMENT_H_
#define ZKX_SERVICE_LAYOUT_ASSIGNMENT_H_
...
class LayoutAssignment : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "layout-assignment"; }
 ...
 protected:
  ...
  // the cost of the instructions being constrained on. New constraints are
 ...
 protected:
  ...
  // case two ends of a channel ended up with a different layout.
...
#endif  // ZKX_SERVICE_LAYOUT_ASSIGNMENT_H_
