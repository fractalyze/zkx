...
#include "zkx/service/scatter_utils.h"
...
absl::StatusOr<HloInstruction*> CheckIndexValidity(
...
absl::StatusOr<std::vector<HloInstruction*>> ScatterLoopBody(
...
//      b. Transform this index into an index into the operand space.
