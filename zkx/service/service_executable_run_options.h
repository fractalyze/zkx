...
#ifndef ZKX_SERVICE_SERVICE_EXECUTABLE_RUN_OPTIONS_H_
#define ZKX_SERVICE_SERVICE_EXECUTABLE_RUN_OPTIONS_H_
...
class ServiceExecutableRunOptions {
 public:
  ...
  absl::StatusOr<StreamPool::Ptr> BorrowStream(
    ...
    if (!stream_borrower_) {
      return absl::UnimplementedError("No stream borrower");
    }
  ...
  absl::StatusOr<std::vector<StreamPool::Ptr>> BorrowStreams(
    ...
    return stream_borrower_
               ...
               : absl::UnimplementedError("No stream borrower");
  }
...
#endif  // ZKX_SERVICE_SERVICE_EXECUTABLE_RUN_OPTIONS_H_
