...
#ifndef ZKX_SERVICE_HLO_GRAPH_DUMPER_H_
#define ZKX_SERVICE_HLO_GRAPH_DUMPER_H_
...
void RegisterGraphToURLRenderer(
    std::function<absl::StatusOr<std::string>(std::string_view dot)> renderer);
...
#endif  // ZKX_SERVICE_HLO_GRAPH_DUMPER_H_
