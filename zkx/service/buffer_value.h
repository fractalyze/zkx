...
#ifndef ZKX_SERVICE_BUFFER_VALUE_H_
#define ZKX_SERVICE_BUFFER_VALUE_H_
...
// TODO(chokobole): Update the comment below if we ultimately don't need
...
class BufferValue {
 public:
  ...
  // TODO(chokobole): Uncomment this after we replace all with
  // Layout::memory_space ABSL_DEPRECATED("Use Layout::memory_space instead.")
  Color color() const {
...
#endif  // ZKX_SERVICE_BUFFER_VALUE_H_
