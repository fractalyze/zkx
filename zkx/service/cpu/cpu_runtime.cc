...
extern const char* const kAcquireInfeedBufferForDequeueSymbolName =
    "__zkx_cpu_runtime_AcquireInfeedBufferForDequeue";
...
extern const char* const kAcquireOutfeedBufferForPopulationSymbolName =
    "__zkx_cpu_runtime_AcquireOutfeedBufferForPopulation";
extern const char* const kReleaseOutfeedBufferAfterPopulationSymbolName =
    "__zkx_cpu_runtime_ReleaseOutfeedBufferAfterPopulation";
extern const char* const kParallelForkJoinSymbolName =
    "__zkx_cpu_runtime_ParallelForkJoin";
extern const char* const kPrintfToStderrSymbolName =
    "__zkx_cpu_runtime_PrintfToStderr";
extern const char* const kStatusIsSuccessSymbolName =
    "__zkx_cpu_runtime_StatusIsSuccess";
extern const char* const kKeyValueSortSymbolName =
    "__zkx_cpu_runtime_KeyValueSort";
extern const char* const kTracingStartSymbolName =
    "__zkx_cpu_runtime_TracingStart";
extern const char* const kTracingEndSymbolName = "__zkx_cpu_runtime_TracingEnd";
extern const char* const kZkxCpuRuntimeSymbolNamePrefix = "__zkx_cpu_runtime_";
extern const char* const kAllReduceSymbolName = "__zkx_cpu_runtime_AllReduce";
extern const char* const kAllGatherSymbolName = "__zkx_cpu_runtime_AllGather";
extern const char* const kReduceScatterSymbolName =
    "__zkx_cpu_runtime_ReduceScatter";
extern const char* const kAllToAllSymbolName = "__zkx_cpu_runtime_AllToAll";
extern const char* const kCollectivePermuteSymbolName =
    "__zkx_cpu_runtime_CollectivePermute";
extern const char* const kPartitionIdSymbolName =
    "__zkx_cpu_runtime_PartitionId";
extern const char* const kReplicaIdSymbolName = "__zkx_cpu_runtime_ReplicaId";
...
DEFINE_MLIR_C_INTERFACE_FUNCTION(PrintMemrefBn254Sf);
...
DEFINE_MLIR_C_INTERFACE_FUNCTION(PrintMemref1DBn254Sf);
...
void ReduceScatterImpl(const ExecutableRunOptions* run_options,
  ...
  CpuCollectives::Executor executor(rendezvous_key, DefaultCollectiveTimeout());
  CHECK_OK(communicator->ReduceScatter(
...
void AllReduceImpl(const ExecutableRunOptions* run_options,
  ...
  for (int i = 0; i < num_buffers; i++) {
    Shape subshape = num_buffers == 1 ? shape : shape.tuple_shapes(i);
    CHECK_OK(communicator->AllReduce(
...
void CollectivePermuteImpl(const ExecutableRunOptions* run_options,
  ...
  CHECK_OK(communicator->CollectivePermute(
...
ABSL_ATTRIBUTE_NO_SANITIZE_MEMORY int __zkx_cpu_runtime_PrintfToStderr(
    const char* format, ...) {
  VLOG(3) << "__zkx_cpu_runtime_PrintfToStderr " << format;
  va_list args;
...
ABSL_ATTRIBUTE_NO_SANITIZE_MEMORY int64_t __zkx_cpu_runtime_TracingStart(
...
void* __zkx_cpu_runtime_AcquireInfeedBufferForDequeue(
    const zkx::ExecutableRunOptions* run_options, int32_t buffer_length,
    const void* shape, int32_t shape_length) {
  return zkx::cpu::runtime::AcquireInfeedBufferForDequeueImpl(
      run_options, buffer_length, shape, shape_length);
}

void __zkx_cpu_runtime_ReleaseInfeedBufferAfterDequeue(
    const zkx::ExecutableRunOptions* run_options, int32_t buffer_length,
    void* buffer_ptr, const void* shape_ptr, int32_t shape_length) {
  return zkx::cpu::runtime::ReleaseInfeedBufferAfterDequeueImpl(
      run_options, buffer_length, buffer_ptr, shape_ptr, shape_length);
}

void* __zkx_cpu_runtime_AcquireOutfeedBufferForPopulation(
    const zkx::ExecutableRunOptions* run_options, int32_t buffer_length,
    const void* shape_ptr, int32_t shape_length) {
  return zkx::cpu::runtime::AcquireOutfeedBufferForPopulationImpl(
      run_options, buffer_length, shape_ptr, shape_length);
}

void __zkx_cpu_runtime_ReleaseOutfeedBufferAfterPopulation(
    const zkx::ExecutableRunOptions* run_options, int32_t buffer_length,
    void* buffer_ptr, const void* shape_ptr, int32_t shape_length) {
  return zkx::cpu::runtime::ReleaseOutfeedBufferAfterPopulationImpl(
      run_options, buffer_length, buffer_ptr, shape_ptr, shape_length);
}

void __zkx_cpu_runtime_AllToAll(const zkx::ExecutableRunOptions* run_options,
                                int32_t channel_id_present, int64_t op_id,
                                const void* replica_groups_str,
                                int32_t replica_groups_str_size,
...
void __zkx_cpu_runtime_AllGather(const zkx::ExecutableRunOptions* run_options,
  ...
  return zkx::cpu::runtime::AllGatherImpl(
...
void __zkx_cpu_runtime_ReduceScatter(
    const zkx::ExecutableRunOptions* run_options,
  ...
  return zkx::cpu::runtime::ReduceScatterImpl(
...
void __zkx_cpu_runtime_AllReduce(const zkx::ExecutableRunOptions* run_options,
                                 const void* replica_groups_str,
                                 int32_t replica_groups_str_size,
                                 int32_t channel_id_present,
                                 int32_t use_global_device_ids, int64_t op_id,
                                 ...
                                 int32_t shape_length, int32_t num_buffers,
                                 void** input_buffers, void** output_buffers) {
  return zkx::cpu::runtime::AllReduceImpl(
      run_options, replica_groups_str, replica_groups_str_size,
      channel_id_present, use_global_device_ids, op_id, reduction_kind,
      shape_ptr, shape_length, num_buffers, input_buffers, output_buffers);
}

void __zkx_cpu_runtime_ReplicaId(const zkx::ExecutableRunOptions* run_options,
                                 void* output_buffer) {
  return zkx::cpu::runtime::ReplicaIdImpl(run_options, output_buffer);
}

void __zkx_cpu_runtime_PartitionId(const zkx::ExecutableRunOptions* run_options,
                                   void* output_buffer) {
  return zkx::cpu::runtime::PartitionIdImpl(run_options, output_buffer);
}

void __zkx_cpu_runtime_CollectivePermute(
    const zkx::ExecutableRunOptions* run_options, int32_t channel_id_present,
  ...
  return zkx::cpu::runtime::CollectivePermuteImpl(
