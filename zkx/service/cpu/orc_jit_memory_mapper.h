...
#ifndef ZKX_SERVICE_CPU_ORC_JIT_MEMORY_MAPPER_H_
#define ZKX_SERVICE_CPU_ORC_JIT_MEMORY_MAPPER_H_
...
class Registrar {
 public:
  ...
  // null.
  // Precondition:  no other memory mapper has been registered yet.
  explicit Registrar(
...
#define ZKX_INTERNAL_REGISTER_ORC_JIT_MEMORY_MAPPER(mapper_instance, ctr) \
  static ::zkx::cpu::orc_jit_memory_mapper::Registrar                     \
  ZKX_INTERNAL_REGISTER_ORC_JIT_MEMORY_MAPPER_NAME(ctr)(mapper_instance)

// __COUNTER__ must go through another macro to be properly expanded
#define ZKX_INTERNAL_REGISTER_ORC_JIT_MEMORY_MAPPER_NAME(ctr) \
...
#define ZKX_REGISTER_ORC_JIT_MEMORY_MAPPER(factory) \
  ZKX_INTERNAL_REGISTER_ORC_JIT_MEMORY_MAPPER(factory, __COUNTER__)

}  // namespace zkx::cpu

#endif  // ZKX_SERVICE_CPU_ORC_JIT_MEMORY_MAPPER_H_
