...
TEST_F(InstructionFusionTest, DotOperationFusion_Basic_0) {
  ...
  HloInstruction* arg0 = builder.AddInstruction(HloInstruction::CreateParameter(
      0, ShapeUtil::MakeShape(S32, {1024, 256}), "arg0"));
  HloInstruction* arg1 = builder.AddInstruction(HloInstruction::CreateParameter(
      1, ShapeUtil::MakeShape(S32, {256}), "arg1"));

  HloInstruction* negate0 = builder.AddInstruction(HloInstruction::CreateUnary(
      ShapeUtil::MakeShape(S32, {1024, 256}), HloOpcode::kNegate, arg0));
  HloInstruction* dot = builder.AddInstruction(
      MakeDot(ShapeUtil::MakeShape(S32, {1024}), negate0, arg1));
...
TEST_F(InstructionFusionTest, DotOperationFusion_Basic_1) {
  HloComputation::Builder builder(TestName());
  HloInstruction* arg0 = builder.AddInstruction(HloInstruction::CreateParameter(
      0, ShapeUtil::MakeShape(S32, {256}), "arg0"));
  HloInstruction* arg1 = builder.AddInstruction(HloInstruction::CreateParameter(
      1, ShapeUtil::MakeShape(S32, {256, 1024}), "arg1"));

  HloInstruction* negate1 = builder.AddInstruction(HloInstruction::CreateUnary(
      ShapeUtil::MakeShape(S32, {256, 1024}), HloOpcode::kNegate, arg1));
  HloInstruction* dot = builder.AddInstruction(
      MakeDot(ShapeUtil::MakeShape(S32, {1024}), arg0, negate1));
...
TEST_F(InstructionFusionTest, DotOperationFusion_Bitcast) {
  HloComputation::Builder builder(TestName());
  HloInstruction* arg0 = builder.AddInstruction(HloInstruction::CreateParameter(
      0, ShapeUtil::MakeShape(S32, {2, 512, 2, 128}), "arg0"));
  HloInstruction* arg1 = builder.AddInstruction(HloInstruction::CreateParameter(
      1, ShapeUtil::MakeShape(S32, {256}), "arg1"));

  HloInstruction* negate0 = builder.AddInstruction(HloInstruction::CreateUnary(
      ShapeUtil::MakeShape(S32, {2, 512, 2, 128}), HloOpcode::kNegate, arg0));
  HloInstruction* bitcast0 = builder.AddInstruction(HloInstruction::CreateUnary(
      ShapeUtil::MakeShape(S32, {1024, 256}), HloOpcode::kBitcast, negate0));
  HloInstruction* dot = builder.AddInstruction(
      MakeDot(ShapeUtil::MakeShape(S32, {1024}), bitcast0, arg1));
...
TEST_F(InstructionFusionTest, DotOperationFusion_Reshape) {
  ...
  HloInstruction* reshape0 =
      builder.AddInstruction(HloInstruction::CreateReshape(
          ShapeUtil::MakeShape(S32, {1024, 256}), negate0));
  HloInstruction* dot = builder.AddInstruction(
      MakeDot(ShapeUtil::MakeShape(S32, {1024}), reshape0, arg1));
...
TEST_F(InstructionFusionTest, DotOperationFusion_TooLarge) {
  HloComputation::Builder builder(TestName());
  HloInstruction* arg0 = builder.AddInstruction(HloInstruction::CreateParameter(
      0, ShapeUtil::MakeShape(S32, {32 * 1024}), "arg0"));
  HloInstruction* arg1 = builder.AddInstruction(HloInstruction::CreateParameter(
      1, ShapeUtil::MakeShape(S32, {32 * 1024, 256}), "arg1"));

  HloInstruction* negate1 = builder.AddInstruction(HloInstruction::CreateUnary(
      ShapeUtil::MakeShape(S32, {32 * 1024, 256}), HloOpcode::kNegate, arg1));
  HloInstruction* dot = builder.AddInstruction(
      MakeDot(ShapeUtil::MakeShape(S32, {256}), arg0, negate1));
...
TEST_F(InstructionFusionTest, DotOperationFusion_ElementReuse) {
  HloComputation::Builder builder(TestName());
  HloInstruction* arg0 = builder.AddInstruction(HloInstruction::CreateParameter(
      0, ShapeUtil::MakeShape(S32, {2, 256}), "arg0"));
  HloInstruction* arg1 = builder.AddInstruction(HloInstruction::CreateParameter(
      1, ShapeUtil::MakeShape(S32, {256, 1024}), "arg1"));
  ...
  HloInstruction* negate1 = builder.AddInstruction(HloInstruction::CreateUnary(
      ShapeUtil::MakeShape(S32, {256, 1024}), HloOpcode::kNegate, arg1));
  HloInstruction* dot = builder.AddInstruction(
      MakeDot(ShapeUtil::MakeShape(S32, {2, 1024}), arg0, negate1));
...
ENTRY DotOperationFusion_TransposeFusion {
  arg0 = s32[1,256] parameter(0)
  arg1 = s32[1024,256] parameter(1)
  negate = s32[1024,256] negate(arg1)
  transpose = s32[256,1024] transpose(negate), dimensions={1,0}
  ROOT dot = s32[1,1024] dot(arg0, transpose), lhs_contracting_dims={1},
  ...
  ASSERT_THAT(computation->root_instruction(),
              op::Dot(op::Parameter(0), op::Negate(op::Parameter(1)),
...
ENTRY DotOperationFusion_TransposeFusion {
  arg0 = s32[256,1] parameter(0)
  arg1 = s32[256,1024] parameter(1)
  transpose = s32[1,256] transpose(arg0), dimensions={1,0}
  negate = s32[256,1024] negate(arg1)
  ROOT dot = s32[1,1024] dot(transpose, negate),
...
class OpcodeFusionTest : public InstructionFusionTest {
 protected:
  ...
  HloComputation* CreateAdderToOne(HloModule* module) {
    ...
    HloInstruction* arg0 =
        builder.AddInstruction(HloInstruction::CreateParameter(
            0, ShapeUtil::MakeShape(S32, {}), "arg0"));
    HloInstruction* one = builder.AddInstruction(
        HloInstruction::CreateConstant(LiteralUtil::CreateR0<int32_t>(1)));
    builder.AddInstruction(HloInstruction::CreateBinary(
        ShapeUtil::MakeShape(S32, {}), HloOpcode::kAdd, arg0, one));
  ...
  HloComputation* CreateMax(HloModule* module) {
    ...
    HloInstruction* arg1 =
        builder.AddInstruction(HloInstruction::CreateParameter(
            1, ShapeUtil::MakeShape(S32, {}), "arg1"));
    builder.AddInstruction(HloInstruction::CreateBinary(
        ShapeUtil::MakeShape(S32, {}), HloOpcode::kMaximum, arg0, arg1));
    return module->AddEmbeddedComputation(builder.Build());
  }
};

TEST_F(OpcodeFusionTest, Not_Reshape_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {1, 4});
  Shape result_shape = ShapeUtil::MakeShape(S32, {4});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
  HloInstruction* not1 = builder.AddInstruction(
      HloInstruction::CreateUnary(param_shape, HloOpcode::kNot, param0));
  HloInstruction* reshape2 =
      builder.AddInstruction(HloInstruction::CreateReshape(result_shape, not1));
  ...
  RunFusionAndCheckOpcodesWereFused(
      module.get(), {HloOpcode::kNot, HloOpcode::kReshape, HloOpcode::kNegate,
                     HloOpcode::kParameter});
}

TEST_F(OpcodeFusionTest, Broadcast_Reshape_DynamicSlice_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {8});
  Shape starts_shape = ShapeUtil::MakeShape(S32, {});
  Shape broadcast_shape = ShapeUtil::MakeShape(S32, {1, 8, 8});
  Shape reshape_shape = ShapeUtil::MakeShape(S32, {8, 8});
  Shape dynamic_slice_shape = ShapeUtil::MakeShape(S32, {4, 4});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
  ...
  builder.AddInstruction(HloInstruction::CreateUnary(
      dynamic_slice_shape, HloOpcode::kNegate, dynamic_slice4));
  ...
  RunFusionAndCheckOpcodesWereFused(
      module.get(),
      {HloOpcode::kNegate, HloOpcode::kDynamicSlice, HloOpcode::kReshape,
...
TEST_F(OpcodeFusionTest, Broadcast_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {8});
  Shape result_shape = ShapeUtil::MakeShape(S32, {8, 8});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
...
TEST_F(OpcodeFusionTest, DynamicSlice_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {4});
  Shape slice_shape = ShapeUtil::MakeShape(S32, {});
  Shape result_shape = ShapeUtil::MakeShape(S32, {2});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
  HloInstruction* param1 = builder.AddInstruction(
...
TEST_F(OpcodeFusionTest, Not_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {4});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
  HloInstruction* not1 = builder.AddInstruction(
      HloInstruction::CreateUnary(param_shape, HloOpcode::kNot, param0));
  builder.AddInstruction(
      HloInstruction::CreateUnary(param_shape, HloOpcode::kNegate, not1));
  ...
  RunFusionAndCheckOpcodesWereFused(
      module.get(),
      {HloOpcode::kNot, HloOpcode::kNegate, HloOpcode::kParameter});
}

TEST_F(OpcodeFusionTest, Reshape_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {4, 4});
  Shape result_shape = ShapeUtil::MakeShape(S32, {16});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
...
TEST_F(OpcodeFusionTest, Slice_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {4});
  Shape slice_shape = ShapeUtil::MakeShape(S32, {2});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
...
TEST_F(OpcodeFusionTest, Negate_Transpose_Negate) {
  HloComputation::Builder builder(TestName());
  Shape param_shape = ShapeUtil::MakeShape(S32, {3, 4});
  Shape result_shape = ShapeUtil::MakeShape(S32, {4, 3});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, param_shape, "param"));
  ...
  HloInstruction* negate1 = builder.AddInstruction(
      HloInstruction::CreateUnary(param_shape, HloOpcode::kNegate, param0));
  HloInstruction* transpose2 = builder.AddInstruction(
      HloInstruction::CreateTranspose(result_shape, negate1, {1, 0}));
  builder.AddInstruction(HloInstruction::CreateUnary(
  ...
  RunFusionAndCheckOpcodesWereFused(
      module.get(), {HloOpcode::kNegate, HloOpcode::kTranspose,
                     HloOpcode::kNegate, HloOpcode::kParameter});
}

TEST_F(OpcodeFusionTest, UnaryMapOfNegate) {
  auto module = CreateNewVerifiedModule();

  HloComputation::Builder builder(TestName());
  Shape shape = ShapeUtil::MakeShape(S32, {3, 4});
  HloInstruction* param0 = builder.AddInstruction(
      HloInstruction::CreateParameter(0, shape, "param"));

  HloInstruction* negate = builder.AddInstruction(
      HloInstruction::CreateUnary(shape, HloOpcode::kNegate, param0));
  builder.AddInstruction(HloInstruction::CreateMap(
      shape, {negate}, CreateAdderToOne(module.get())));

  module->AddEntryComputation(builder.Build());

  RunFusionAndCheckOpcodesWereFused(
      module.get(),
      {HloOpcode::kParameter, HloOpcode::kNegate, HloOpcode::kMap});
}

TEST_F(OpcodeFusionTest, BinaryMapOfNegates) {
  auto module = CreateNewVerifiedModule();
  ...
  HloInstruction* negate0 = builder.AddInstruction(
      HloInstruction::CreateUnary(shape, HloOpcode::kNegate, param0));
  HloInstruction* negate1 = builder.AddInstruction(
      HloInstruction::CreateUnary(shape, HloOpcode::kNegate, param1));

  builder.AddInstruction(HloInstruction::CreateMap(shape, {negate0, negate1},
                                                   CreateMax(module.get())));

  module->AddEntryComputation(builder.Build());

  RunFusionAndCheckOpcodesWereFused(
      module.get(), {HloOpcode::kParameter, HloOpcode::kParameter,
                     HloOpcode::kNegate, HloOpcode::kNegate, HloOpcode::kMap});
}
...
TEST_F(OpcodeFusionTest, MessOfFusibleNodes) {
  ...
  Shape full_shape = ShapeUtil::MakeShape(S32, {4, 100, 10, 100, 50});
  ...
  auto slice = builder.AddInstruction(HloInstruction::CreateDynamicSlice(
      ShapeUtil::MakeShape(S32, {1, 100, 10, 100, 50}),
      builder.AddInstruction(HloInstruction::CreateParameter(
          3, ShapeUtil::MakeShape(S32, {100, 100, 10, 100, 50}), "param3")),
...
void CreateComputationForDotAddOutputFusionTest(const std::string& test_name,
  ...
  Shape dot_lhs_shape = ShapeUtil::MakeShape(S32, {m, k});
  Shape dot_rhs_shape = ShapeUtil::MakeShape(S32, {k, n});
  Shape dot_shape = ShapeUtil::MakeShape(S32, {m, n});
  if (m == 1) {
    dot_lhs_shape = ShapeUtil::MakeShape(S32, {k});
    dot_shape = ShapeUtil::MakeShape(S32, {n});
  } else if (n == 1) {
    dot_rhs_shape = ShapeUtil::MakeShape(S32, {k});
    dot_shape = ShapeUtil::MakeShape(S32, {m});
  }
...
ENTRY main {
  a = s32[50,60]{1,0} parameter(0)
  b = s32[60,1]{1,0} parameter(1)
  c = s32[50,1]{1,0} dot(a, b), lhs_contracting_dims={1}, rhs_contracting_dims={0}
  ROOT d = s32[50,1]{1,0} add(c, c)
}
)";
...
ENTRY main {
  a = s32[50,60]{1,0} parameter(0)
  b = s32[50,60]{1,0} parameter(1)
  c = s32[50,60]{1,0} add(a, b)
  init = s32[] constant(0)
  ROOT r = s32[60]{0} reduce(c, init), dimensions={0}, to_apply=add
}
)";
...
ENTRY main {
  ...
  c = s32[50,60]{1,0} add(a, b)
  init = s32[] constant(0)
  ROOT r = s32[] reduce(c, init), dimensions={0,1}, to_apply=add
}
)";
...
ENTRY main {
  a = s32[1000,1000]{1,0} parameter(0)
  b = s32[1000,1000]{1,0} constant({...})
  a_plus_b = s32[1000,1000]{1,0} add(a, b)
  c = s32[1000,1000]{1,0} constant({...})
  ROOT result = s32[1000,1000]{1,0} add(a_plus_b, c)
}
)";
...
ENTRY main {
  a = s32[10,10]{1,0} parameter(0)
  b = s32[10,10]{1,0} constant({...})
  a_plus_b = s32[10,10]{1,0} add(a, b)
  c = s32[10,10]{1,0} constant({...})
  ROOT result = s32[10,10]{1,0} add(a_plus_b, c)
}
)";
...
%fused_computation (param_0: s32[10,10], param_1: s32[10,10]) -> s32[10,10] {
  %param_0 = s32[10,10]{1,0} parameter(0)
  %param_1 = s32[10,10]{1,0} parameter(1)
  %add = s32[10,10]{1,0} add(s32[10,10]{1,0} %param_0, s32[10,10]{1,0} %param_1)
  %subtract = s32[10,10]{1,0} subtract(s32[10,10]{1,0} %param_0, s32[10,10]{1,0} %param_1)
  ROOT %multiply = s32[10,10]{1,0} multiply(s32[10,10]{1,0} %add, s32[10,10]{1,0} %subtract)
}

ENTRY %main (Arg_0: s32[10,10], Arg_1: s32[10,10]) -> s32[10,10] {
  %Arg_0 = s32[10,10]{1,0} parameter(0), metadata={op_name="x"}
  %Arg_1 = s32[10,10]{1,0} parameter(1), metadata={op_name="y"}
  ROOT %subtract_multiply_fusion = s32[10,10]{1,0} fusion(s32[10,10]{1,0} %Arg_0, s32[10,10]{1,0} %Arg_1), kind=kCustom, calls=%fused_computation
}
)";
...
// TODO(batzor): Uncomment this. Dependency: CustomCall
...
//   %param_0 = s32[10,10]{1,0} parameter(0)
//   %param_1 = s32[10,10]{1,0} parameter(1)
//   %add = s32[10,10]{1,0} add(s32[10,10]{1,0} %param_0, s32[10,10]{1,0}
//   %param_1) %subtract = s32[10,10]{1,0} subtract(s32[10,10]{1,0} %param_0,
//   s32[10,10]{1,0} %param_1) ROOT %multiply = s32[10,10]{1,0}
//   multiply(s32[10,10]{1,0} %add, s32[10,10]{1,0} %subtract)
// }

// ENTRY %main (Arg_0: s32[10,10], Arg_1: s32[10,10]) -> s32[10,10] {
//   %Arg_0 = s32[10,10]{1,0} parameter(0), metadata={op_name="x"}
//   %Arg_1 = s32[10,10]{1,0} parameter(1), metadata={op_name="y"}
//   ROOT %custom_call = s32[10,10]{1,0} custom-call(s32[10,10]{1,0} %Arg_0,
//   s32[10,10]{1,0} %Arg_1), custom_call_target="target",
//   called_computations={%custom_computation}
// }
// )";
