...
#ifndef ZKX_SERVICE_CPU_SHAPE_PARTITION_H_
#define ZKX_SERVICE_CPU_SHAPE_PARTITION_H_
...
//
//   Note that the last partition contains a residual range because the
//   dimension size is not a multiple of the partition count.
//
//
// Example 2:
//
...
#endif  // ZKX_SERVICE_CPU_SHAPE_PARTITION_H_
