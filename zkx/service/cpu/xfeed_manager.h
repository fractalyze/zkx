...
#ifndef ZKX_SERVICE_CPU_XFEED_MANAGER_H_
#define ZKX_SERVICE_CPU_XFEED_MANAGER_H_
...
class XfeedQueueManager {
 public:
  explicit XfeedQueueManager(std::string_view queue_name)
      : queue_name_(std::string(queue_name)) {}
...
#endif  // ZKX_SERVICE_CPU_XFEED_MANAGER_H_
