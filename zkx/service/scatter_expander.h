...
#ifndef ZKX_SERVICE_SCATTER_EXPANDER_H_
#define ZKX_SERVICE_SCATTER_EXPANDER_H_
...
class ScatterExpander : public OpExpanderPass {
 public:
  ...
  std::string_view name() const override { return "scatter_expander"; }
...
#endif  // ZKX_SERVICE_SCATTER_EXPANDER_H_
