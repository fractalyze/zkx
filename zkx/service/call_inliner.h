...
#ifndef ZKX_SERVICE_CALL_INLINER_H_
#define ZKX_SERVICE_CALL_INLINER_H_
...
class CallInliner : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "call-inliner"; }
...
#endif  // ZKX_SERVICE_CALL_INLINER_H_
