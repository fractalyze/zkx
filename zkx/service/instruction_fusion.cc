...
// static
bool InstructionFusion::IsExpensive(const HloInstruction& instruction) {
  namespace m = match;
  ...
  switch (instruction.opcode()) {
    ...
    // TODO(batzor): Uncomment this. Dependency: IsFinite
    ...
    // TODO(batzor): Uncomment this. Dependency: RoundNearestEven
...
absl::StatusOr<bool> InstructionFusion::Run(
  ...
  bool dump_fusion =
      module->config().debug_options().zkx_dump_fusion_visualization();
