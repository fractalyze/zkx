...
#ifndef ZKX_SERVICE_COPY_INSERTION_H_
#define ZKX_SERVICE_COPY_INSERTION_H_
...
//       unambiguous and distinct. That is, InstructionAliasSet::IsAmbiguous
//       return false and InstructionAliasSet::IsDistinct return true.
class CopyInsertion : public HloModulePass {
 public:
  std::string_view name() const override { return "copy-insertion"; }
...
#endif  // ZKX_SERVICE_COPY_INSERTION_H_
