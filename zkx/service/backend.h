...
#ifndef ZKX_SERVICE_BACKEND_H_
#define ZKX_SERVICE_BACKEND_H_
...
// Class which encapsulates a ZKX backend. It includes everything necessary
...
class Backend {
 public:
  ...
  // Returns a string identifier for the given device, eg: "GPU:3".
