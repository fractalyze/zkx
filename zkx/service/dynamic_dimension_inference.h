...
#ifndef ZKX_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
#define ZKX_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
...
class DynamicDimensionInference {
 public:
  enum ShapeCheckMode {
    kInvalid = 0,
    // At compile time, pessimistically assumes runtime shape checks may fail
    // and returns a compile-time error.
    kCompileTime,
...
#endif  // ZKX_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
