...
#ifndef ZKX_SERVICE_HEAP_SIMULATOR_ALLOCATION_BLOCK_H_
#define ZKX_SERVICE_HEAP_SIMULATOR_ALLOCATION_BLOCK_H_
...
#endif  // ZKX_SERVICE_HEAP_SIMULATOR_ALLOCATION_BLOCK_H_
