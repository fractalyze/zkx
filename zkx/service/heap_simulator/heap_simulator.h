...
#ifndef ZKX_SERVICE_HEAP_SIMULATOR_HEAP_SIMULATOR_H_
#define ZKX_SERVICE_HEAP_SIMULATOR_HEAP_SIMULATOR_H_
...
#include "zkx/hlo/utils/hlo_live_range.h"
#include "zkx/service/buffer_value.h"
#include "zkx/service/heap_simulator/allocation_block.h"
...
class SliceTimePermutationIterator {
 public:
  enum class Ty : std::int8_t {
    ...
    // preferred permutation iterator only allows the following triangular
    // shapes:
    //
...
#endif  // ZKX_SERVICE_HEAP_SIMULATOR_HEAP_SIMULATOR_H_
