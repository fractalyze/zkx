...
#ifndef ZKX_SERVICE_COMPUTATION_LAYOUT_H_
#define ZKX_SERVICE_COMPUTATION_LAYOUT_H_
...
class ComputationLayout {
 public:
  ...
  // Constructs a ComputationLayout from a `program_shape`. The layouts of the
  // parameters and results are set to the default layout. Layouts in the
  // `program_shape` are ignored if `ignore_layouts` is true.
...
#endif  // ZKX_SERVICE_COMPUTATION_LAYOUT_H_
