...
#ifndef ZKX_SERVICE_MAYBE_OWNING_DEVICE_MEMORY_H_
#define ZKX_SERVICE_MAYBE_OWNING_DEVICE_MEMORY_H_
...
class MaybeOwningDeviceMemory {
 public:
  ...
  explicit MaybeOwningDeviceMemory(se::OwningDeviceMemory owned)
      : mem_(std::move(owned)) {}
  ...
  MaybeOwningDeviceMemory& operator=(se::OwningDeviceMemory owned) {
    mem_ = std::move(owned);
    return *this;
  }
