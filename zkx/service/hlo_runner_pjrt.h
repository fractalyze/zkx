...
#ifndef ZKX_SERVICE_HLO_RUNNER_PJRT_H_
#define ZKX_SERVICE_HLO_RUNNER_PJRT_H_
...
class HloRunnerPjRt : public HloRunnerInterface {
 public:
  ...
  void UpdateEntryComputationLayout(HloModule* module) {
    ...
    zkx::UpdateEntryComputationLayout(module, device_shape_representation_fn_);
  }
...
#endif  // ZKX_SERVICE_HLO_RUNNER_PJRT_H_
