...
#ifndef ZKX_SERVICE_FUSION_NODE_INDEXING_EVALUATION_H_
#define ZKX_SERVICE_FUSION_NODE_INDEXING_EVALUATION_H_
...
class FusionNodeIndexingEvaluation {
 ...
 private:
  ...
  const HloInstruction* fusion_;  // not owned
};
}  // namespace zkx

#endif  // ZKX_SERVICE_FUSION_NODE_INDEXING_EVALUATION_H_
