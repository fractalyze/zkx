...
#ifndef ZKX_SERVICE_LLVM_IR_BUFFER_ASSIGNMENT_UTIL_H_
#define ZKX_SERVICE_LLVM_IR_BUFFER_ASSIGNMENT_UTIL_H_
...
std::string SanitizeConstantName(std::string_view name);

std::string ConstantHloToGlobalName(const HloInstruction& instr);
std::string ConstantNameToGlobalName(std::string_view name);
...
#endif  // ZKX_SERVICE_LLVM_IR_BUFFER_ASSIGNMENT_UTIL_H_
