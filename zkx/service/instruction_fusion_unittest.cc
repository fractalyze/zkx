...
// TODO(batzor): Enable this test. Dependency: Rng
TEST_F(InstructionFusionTest,
       DISABLED_AvoidDuplicationIfNotAllFusibleRecursively) {
...
TEST_F(InstructionFusionTest,
       DISABLED_AllowBinarySameValueOperandsDuplication) {
...
// TODO(batzor): Enable this test. Dependency: Scatter
TEST_F(InstructionFusionTest,
       DISABLED_InPlaceOpShouldNotBeFusedIfItSharesOperand) {
...
TEST_F(InstructionFusionTest, DISABLED_DontFuseProducerIfInplaceConflict) {
  auto module = ParseAndReturnVerifiedModule(R"(
  HloModule test_module
  func {
