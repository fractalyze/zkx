...
#ifndef ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALLOCATION_VALUE_H_
#define ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALLOCATION_VALUE_H_
...
//
// Body {
//   body_param = (u32[4,3]{1,0}, u32[]) parameter(0)
//   get-tuple-element.3 = u32[4,3]{1,0} get-tuple-element(body_param),
//   index=0
//   ...
//   ROOT tuple = (u32[4,3]{1,0}, u32[]) tuple(get-tuple-element.3, ...)
// }
//
// Cond {
//   cond_param = (u32[4,3]{1,0}, u32[]) parameter(0)
//   ...
// }
//
// add.4 = u32[4,3]{1,0} add(...)
// tuple.1 = (u32[4,3]{1,0}, u32[]) tuple(add.4, ...)
// while = (u32[4,3]{1,0}, u32[]) while(tuple.1), body=Body, condition=Cond
// get-tuple-element.5 = u32[4,3]{1,0} get-tuple-element(while), index=0
// add.5 = u32[4,3]{1,0} add(get-tuple-element.5, ...)
//
...
#endif  // ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALLOCATION_VALUE_H_
