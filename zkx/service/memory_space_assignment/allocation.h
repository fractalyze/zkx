...
#ifndef ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALLOCATION_H_
#define ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALLOCATION_H_
...
#include "zkx/service/memory_space_assignment/slice.h"
...
enum class MemorySpace : uint8_t { kDefault, kAlternate };
...
#endif  // ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALLOCATION_H_
