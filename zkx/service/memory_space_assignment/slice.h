...
#ifndef ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_SLICE_H_
#define ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_SLICE_H_
...
#include "zkx/service/memory_space_assignment/memory_space_assignment.pb.h"
#include "zkx/shape.h"
...
class SlicedPrefetchStartTimePicker {
 public:
  ...
  //
  // REQUIRES:
  // - The instructions following each start time are guaranteed to be in the
  //   same computation.
...
#endif  // ZKX_SERVICE_MEMORY_SPACE_ASSIGNMENT_SLICE_H_
