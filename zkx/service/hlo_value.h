...
#ifndef ZKX_SERVICE_HLO_VALUE_H_
#define ZKX_SERVICE_HLO_VALUE_H_
...
// Abstraction which identifies a specific point in the ZKX graph. An
...
// (shape index in the output of an instruction) in the ZKX graph. This set
...
// defined by the instruction's operands or defined further up in the ZKX graph.
class HloValueSet {
 public:
  HloValueSet() = default;
...
#endif  // ZKX_SERVICE_HLO_VALUE_H_
