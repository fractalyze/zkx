...
#ifndef ZKX_SERVICE_LOGICAL_BUFFER_H_
#define ZKX_SERVICE_LOGICAL_BUFFER_H_
...
// NOTE(chokobole): This is included only to ensure BufferAssignment compiles.
...
#endif  // ZKX_SERVICE_LOGICAL_BUFFER_H_
