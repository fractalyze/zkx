...
#ifndef ZKX_SERVICE_GPU_EXECUTION_STREAM_ASSIGNMENT_H_
#define ZKX_SERVICE_GPU_EXECUTION_STREAM_ASSIGNMENT_H_
...
#endif  // ZKX_SERVICE_GPU_EXECUTION_STREAM_ASSIGNMENT_H_
