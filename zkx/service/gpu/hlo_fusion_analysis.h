...
#ifndef ZKX_SERVICE_GPU_HLO_FUSION_ANALYSIS_H_
#define ZKX_SERVICE_GPU_HLO_FUSION_ANALYSIS_H_
...
class HloFusionAnalysis {
 ...
 private:
  ...
  bool HasConsistentTransposeHeroes() const;
...
#endif  // ZKX_SERVICE_GPU_HLO_FUSION_ANALYSIS_H_
