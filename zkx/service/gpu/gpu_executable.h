...
#ifndef ZKX_SERVICE_GPU_GPU_EXECUTABLE_H_
#define ZKX_SERVICE_GPU_GPU_EXECUTABLE_H_
...
#include "zkx/stream_executor/scoped_module_handle.h"
#include "zkx/stream_executor/stream_executor.h"

namespace zkx::gpu {

// GPU-targeting implementation of the ZKX Executable interface.
//
...
class GpuExecutable : public Executable {
 ...
 private:
  ...
  // IrEmitter (null if ZKX:GPU runtime is enabled).
  ...
  std::unique_ptr<const BufferAssignment> buffer_assignment_;

  // TODO(chokobole): Uncomment this. Dependency: ModuleAnnotation
  ...
  // Retains shared ownership of on-device constants that are managed by ZKX and
...
#endif  // ZKX_SERVICE_GPU_GPU_EXECUTABLE_H_
