...
#ifndef ZKX_SERVICE_GPU_INFEED_MANAGER_H_
#define ZKX_SERVICE_GPU_INFEED_MANAGER_H_
...
#include "zkx/service/gpu/xfeed_queue.h"
#include "zkx/shape_tree.h"
#include "zkx/stream_executor/device_memory_handle.h"
...
// and it does not handle the case when it runs out of memory. Potential
// solution is to pre-allocate a fixed amount of memory and block when that
// memory is full.
...
#endif  // ZKX_SERVICE_GPU_INFEED_MANAGER_H_
