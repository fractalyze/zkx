...
using ::se::cuda::CompilationOptions;
using ::testing::Field;
...
TEST(PtxCompileOptionsFromDebugOptionsTest, OptimizationsCanBeDisabled) {
  DebugOptions debug_options;
  debug_options.set_zkx_gpu_disable_gpuasm_optimizations(true);
  EXPECT_THAT(
...
TEST(PtxCompileOptionsFromDebugOptionsTest, LineInfoCanBeEnabled) {
  DebugOptions debug_options;
  debug_options.set_zkx_gpu_generate_line_info(true);
  EXPECT_THAT(
      PtxCompileOptionsFromDebugOptions(debug_options,
                                        /*is_autotuning_compilation=*/false),
...
TEST(PtxCompileOptionsFromDebugOptionsTest, DebugInfoCanBeEnabled) {
  DebugOptions debug_options;
  debug_options.set_zkx_gpu_generate_debug_info(true);
  EXPECT_THAT(
      PtxCompileOptionsFromDebugOptions(debug_options,
                                        /*is_autotuning_compilation=*/false),
...
TEST(PtxCompileOptionsFromDebugOptionsTest,
  ...
  DebugOptions debug_options;
  debug_options.set_zkx_gpu_filter_kernels_spilling_registers_on_autotuning(
      true);
  EXPECT_THAT(
      PtxCompileOptionsFromDebugOptions(debug_options,
                                        /*is_autotuning_compilation=*/false),
...
TEST(PtxCompileOptionsFromDebugOptionsTest,
  ...
  DebugOptions debug_options;
  debug_options.set_zkx_gpu_fail_ptx_compilation_on_register_spilling(true);
  EXPECT_THAT(
      PtxCompileOptionsFromDebugOptions(debug_options,
                                        /*is_autotuning_compilation=*/false),
      Field(&CompilationOptions::cancel_if_reg_spill, true));
