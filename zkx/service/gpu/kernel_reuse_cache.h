...
==============================================================================*/
#ifndef ZKX_SERVICE_GPU_KERNEL_REUSE_CACHE_H_
#define ZKX_SERVICE_GPU_KERNEL_REUSE_CACHE_H_
...
class KernelReuseCache {
 public:
  struct Entry {
    ...
    std::string binary;
    std::optional<se::gpu::TmaMetadata> tma_metadata;
  };
  struct NamedBinary {
    std::string name;
...
absl::Status UpdateDiskKernelCache(
    std::string_view path, bool do_append,
...
#endif  // ZKX_SERVICE_GPU_KERNEL_REUSE_CACHE_H_
