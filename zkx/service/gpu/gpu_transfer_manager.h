...
#ifndef ZKX_SERVICE_GPU_GPU_TRANSFER_MANAGER_H_
#define ZKX_SERVICE_GPU_GPU_TRANSFER_MANAGER_H_
...
#include "zkx/service/gpu/infeed_manager.h"
#include "zkx/service/gpu/outfeed_manager.h"
...
class GpuTransferManager : public GenericTransferManager {
 ...
 private:
  ...
  // transferring literals to and from device. We keep a separate staging
  ...
  // TODO(ezhulenev): Unify this with staged buffers for transferring literals.
  ...
  // memory allocator, and we could in theory use it here and elsewhere in ZKX.
  ...
  // = 32, which is much larger than we normally see in ZKX programs. A 128 KiB
