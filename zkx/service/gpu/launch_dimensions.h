...
#ifndef ZKX_SERVICE_GPU_LAUNCH_DIMENSIONS_H_
#define ZKX_SERVICE_GPU_LAUNCH_DIMENSIONS_H_
...
class LaunchDimensions {
 public:
  // The default constructor creates a launch dimension that indicates
...
#endif  // ZKX_SERVICE_GPU_LAUNCH_DIMENSIONS_H_
