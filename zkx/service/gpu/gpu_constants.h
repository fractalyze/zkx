...
#ifndef ZKX_SERVICE_GPU_GPU_CONSTANTS_H_
#define ZKX_SERVICE_GPU_GPU_CONSTANTS_H_
...
// builds and we don't want the IR generated by ZKX:GPU to depend on that.
//
// TODO(b/111767313): Consider raising EIGEN_MAX_ALIGN_BYTES if it helps.
inline constexpr int64_t kEntryParameterAlignBytes = 16;

// Minimum alignment for buffers allocated by ZKX: the temp buffers and the live
// out (result) buffers.
//
...
//
inline constexpr int64_t kZkxAllocatedBufferAlignBytes = 128;

// Minimum alignment for constant buffers.
inline constexpr int64_t kConstantBufferAlignBytes =
    kZkxAllocatedBufferAlignBytes;

}  // namespace zkx::gpu

#endif  // ZKX_SERVICE_GPU_GPU_CONSTANTS_H_
