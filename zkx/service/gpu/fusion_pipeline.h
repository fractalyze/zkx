...
#ifndef ZKX_SERVICE_GPU_FUSION_PIPELINE_H_
#define ZKX_SERVICE_GPU_FUSION_PIPELINE_H_
...
// Function wrapper around the (non-horizontal) ZKX GPU fusion pipeline.
...
// Function wrapper around the horizontal ZKX GPU fusion pipeline.
HloPassPipeline HorizontalFusionPipeline(
    const se::DeviceDescription& gpu_device_info);

}  // namespace zkx::gpu

#endif  // ZKX_SERVICE_GPU_FUSION_PIPELINE_H_
