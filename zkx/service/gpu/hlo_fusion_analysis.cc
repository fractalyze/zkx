...
//   * Either the root has a transpose hero with the same normalized dimensions
...
// Returns true if the fusion has consistent transpose heroes.
bool HloFusionAnalysis::HasConsistentTransposeHeroes() const {
...
HloFusionAnalysis::EmitterFusionKind HloFusionAnalysis::GetEmitterFusionKind()
  ...
  if (HasConsistentTransposeHeroes()) {
