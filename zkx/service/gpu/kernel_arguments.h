...
==============================================================================*/
#ifndef ZKX_SERVICE_GPU_KERNEL_ARGUMENTS_H_
#define ZKX_SERVICE_GPU_KERNEL_ARGUMENTS_H_
...
class KernelArgument {
 ...
 private:
  KernelArgument(const Shape& shape, BufferAllocation::Slice slice,
                 bool written)
...
#endif  // ZKX_SERVICE_GPU_KERNEL_ARGUMENTS_H_
