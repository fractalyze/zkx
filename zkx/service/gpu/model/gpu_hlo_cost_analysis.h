...
#ifndef ZKX_SERVICE_GPU_MODEL_GPU_HLO_COST_ANALYSIS_H_
#define ZKX_SERVICE_GPU_MODEL_GPU_HLO_COST_ANALYSIS_H_
...
class GpuHloCostAnalysis : public HloCostAnalysis {
 ...
 protected:
  ...
  bool KeyToCopyFromSubcomputation(std::string_view key) const override;
...
#endif  // ZKX_SERVICE_GPU_MODEL_GPU_HLO_COST_ANALYSIS_H_
