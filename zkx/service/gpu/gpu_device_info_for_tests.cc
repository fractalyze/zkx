...
// static
se::DeviceDescription TestGpuDeviceInfo::RTXA6000DeviceInfo(
    se::GpuComputeCapability cc) {
  se::DeviceDescription b;
  ...
  b.set_runtime_version(se::SemanticVersion{12, 4, 0});
  b.set_driver_version(se::SemanticVersion{12, 4, 0});
  return b;
}

// static
se::DeviceDescription TestGpuDeviceInfo::AMDMI210DeviceInfo() {
  se::DeviceDescription b;
  b.set_gpu_compute_capability(se::RocmComputeCapability("gfx90a"));
  b.set_threads_per_block_limit(1024);
  ...
  b.set_runtime_version(se::SemanticVersion{6, 0, 0});
  b.set_driver_version(se::SemanticVersion{6, 0, 0});
  return b;
}

// static
se::DeviceDescription TestGpuDeviceInfo::CudaOrRocmDeviceInfo() {
