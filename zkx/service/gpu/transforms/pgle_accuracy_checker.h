...
#ifndef ZKX_SERVICE_GPU_TRANSFORMS_PGLE_ACCURACY_CHECKER_H_
#define ZKX_SERVICE_GPU_TRANSFORMS_PGLE_ACCURACY_CHECKER_H_
...
class PGLEAccuracyChecker : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "pgle-accuracy-checker"; }
...
#endif  // ZKX_SERVICE_GPU_TRANSFORMS_PGLE_ACCURACY_CHECKER_H_
