...
#ifndef ZKX_SERVICE_GPU_TRANSFORMS_SCHEDULE_POSTPROCESSING_H_
#define ZKX_SERVICE_GPU_TRANSFORMS_SCHEDULE_POSTPROCESSING_H_
...
// operations, assuming the runtime won't use those values.
//
class SchedulePostprocessing : public HloModulePass {
 public:
  std::string_view name() const override { return "schedule-postprocessing"; }
...
#endif  // ZKX_SERVICE_GPU_TRANSFORMS_SCHEDULE_POSTPROCESSING_H_
