...
#ifndef ZKX_SERVICE_GPU_GPU_LATENCY_HIDING_SCHEDULER_H_
#define ZKX_SERVICE_GPU_GPU_LATENCY_HIDING_SCHEDULER_H_
...
class GpuAsyncTracker : public GpuAsyncTrackerBase {
 public:
  ...
  std::string_view GetResourceName(int64_t resource_type) const override;
...
#endif  // ZKX_SERVICE_GPU_GPU_LATENCY_HIDING_SCHEDULER_H_
