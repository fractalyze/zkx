...
#ifndef ZKX_SERVICE_NAME_UNIQUER_H_
#define ZKX_SERVICE_NAME_UNIQUER_H_
...
class NameUniquer {
 public:
  ...
  static std::string GetSanitizedName(std::string_view name);
...
#endif  // ZKX_SERVICE_NAME_UNIQUER_H_
