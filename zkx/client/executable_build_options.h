...
#ifndef ZKX_CLIENT_EXECUTABLE_BUILD_OPTIONS_H_
#define ZKX_CLIENT_EXECUTABLE_BUILD_OPTIONS_H_
...
class ExecutableBuildOptions {
 public:
  ...
  // Expose access to the ZKX compilation environments, which will be passed to
  ...
  // Expose access to the ZKX debug options which will be passed to the
  ...
  // By default, ZKX builds an executable by invoking standard compilation, i.e,
  // running Compiler::Compile, or both Compiler::RunHloPasses and
  // Compiler::RunBackend. When run_backend_only is set to true, ZKX builds an
...
#endif  // ZKX_CLIENT_EXECUTABLE_BUILD_OPTIONS_H_
