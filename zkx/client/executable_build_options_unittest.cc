...
TEST(ExecutableBuildOptionsTest, ProtoRoundTripWorks) {
  ...
  // clang-format off
  // TODO(chokobole): Uncomment this. Dependency: DebugOptions::zkx_gpu_force_compilation_parallelism
  // clang-format on
  // p.mutable_debug_options()->set_zkx_gpu_force_compilation_parallelism(3);
