...
#ifndef ZKX_LAYOUT_UTIL_H_
#define ZKX_LAYOUT_UTIL_H_
...
class LayoutUtil {
 public:
  ...
  // default.
  // TODO(chokobole): Uncomment this. Dependency: ProgramShape
  ...
  // Returns whether the given Shape is a sparse array and has a CSC (compressed
  // sparse column) in-memory representation.
  ...
  static DimLevelType GetDimLevelType(const Layout& layout, int64_t dim);
  ...
  static bool ValidateDimLevel(DimLevelType dim_level_type, bool dim_unique,
                               bool dim_ordered);
