...
#ifndef ZKX_CORE_COLLECTIVES_COMMUNICATOR_H_
#define ZKX_CORE_COLLECTIVES_COMMUNICATOR_H_
...
// Collective communicator defines the set of communicating ZKX processes.
class Communicator {
 public:
  ...
  RegisterBuffer(se::DeviceMemoryBase buffer) {
  ...
  virtual absl::Status Abort() {
    return absl::UnimplementedError("Aborting communicator is not implemented");
  }
...
#endif  // ZKX_CORE_COLLECTIVES_COMMUNICATOR_H_
