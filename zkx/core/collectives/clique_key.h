...
#ifndef ZKX_CORE_COLLECTIVES_CLIQUE_KEY_H_
#define ZKX_CORE_COLLECTIVES_CLIQUE_KEY_H_
...
class CliqueKey {
 public:
  CliqueKey(absl::Span<const GlobalDeviceId> devices)
  ...
  absl::Span<const GlobalDeviceId> devices() const { return devices_; }
...
#endif  // ZKX_CORE_COLLECTIVES_CLIQUE_KEY_H_
