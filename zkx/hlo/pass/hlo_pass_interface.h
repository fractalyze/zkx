...
#ifndef ZKX_HLO_PASS_HLO_PASS_INTERFACE_H_
#define ZKX_HLO_PASS_HLO_PASS_INTERFACE_H_
...
class HloPassInterface {
 public:
  ...
  virtual absl::StatusOr<bool> Run(
      HloModule* module,
      const absl::flat_hash_set<std::string_view>& execution_threads) = 0;
...
class HloModuleGroupPass : public HloPassInterface {
 public:
  absl::StatusOr<bool> Run(
      HloModule* module,
      const absl::flat_hash_set<std::string_view>& execution_threads) override {
    return absl::InternalError("Module group pass cannot be run on a module");
  }
};

}  // namespace zkx

#endif  // ZKX_HLO_PASS_HLO_PASS_INTERFACE_H_
