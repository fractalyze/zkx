...
#ifndef ZKX_HLO_TESTLIB_HLO_HARDWARE_INDEPENDENT_TEST_BASE_H_
#define ZKX_HLO_TESTLIB_HLO_HARDWARE_INDEPENDENT_TEST_BASE_H_
...
class HloHardwareIndependentTestBase : public ::testing::Test {
 ...
 protected:
  ...
  // result.
  void RunAndFilecheckHloRewrite(
      std::string_view hlo_with_filecheck_lines, HloPassInterface&& hlo_pass,
  ...
  // Reference overload.
  absl::StatusOr<std::unique_ptr<HloModule>> RunAndCheckHloRewrite(
      std::string_view hlo_template, const HloPassInterface& hlo_pass,
      bool expect_change = true, FixedMapping params = {}) const {
...
#endif  // ZKX_HLO_TESTLIB_HLO_HARDWARE_INDEPENDENT_TEST_BASE_H_
