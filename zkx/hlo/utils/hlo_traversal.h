...
==============================================================================*/
#ifndef ZKX_HLO_UTILS_HLO_TRAVERSAL_H_
#define ZKX_HLO_UTILS_HLO_TRAVERSAL_H_
...
class HloInstructionAdaptor {
 public:
  ...
  std::string_view name() const { return instruction_->name(); }
  ...
  const Shape& shape() const { return instruction_->shape(); }
...
#endif  // ZKX_HLO_UTILS_HLO_TRAVERSAL_H_
