...
#ifndef ZKX_HLO_ANALYSIS_INDEXING_ANALYSIS_H_
#define ZKX_HLO_ANALYSIS_INDEXING_ANALYSIS_H_
...
//           ROOT
//
// Here, we must use the path through the `log` for the epilogue indexing,
...
// Computes producer indexing maps and fuses/composes them with the consumer
// indexing maps.
...
#endif  // ZKX_HLO_ANALYSIS_INDEXING_ANALYSIS_H_
