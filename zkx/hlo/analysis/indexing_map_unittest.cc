...
class IndexingMapTest : public HloTestBase {
 public:
  IndexingMap Parse(std::string_view indexing_map_str) {
...
TEST_F(IndexingMapTest, VariableKind) {
  EXPECT_EQ(ToVariableKind("default"), VariableKind::kDefault);
  EXPECT_EQ(ToVariableKind("th_x"), VariableKind::kThreadX);
  EXPECT_EQ(ToVariableKind("th_y"), VariableKind::kThreadY);
  EXPECT_EQ(ToVariableKind("th_z"), VariableKind::kThreadZ);
  EXPECT_EQ(ToVariableKind("bl_x"), VariableKind::kBlockX);
  EXPECT_EQ(ToVariableKind("bl_y"), VariableKind::kBlockY);
  EXPECT_EQ(ToVariableKind("bl_z"), VariableKind::kBlockZ);
  EXPECT_EQ(ToVariableKind("warp"), VariableKind::kWarp);
  EXPECT_EQ(ToVariableKind("th_w"), VariableKind::kWarpThread);
