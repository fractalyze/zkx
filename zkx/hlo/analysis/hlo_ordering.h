...
#ifndef ZKX_HLO_ANALYSIS_HLO_ORDERING_H_
#define ZKX_HLO_ANALYSIS_HLO_ORDERING_H_
...
class HloOrdering {
 public:
  ...
  enum class ExecutionConstraint {
    ...
    kRunAfter,
    // An order cannot be determined as a and b do not have a common ancestor.
    kUnordered,
  };
...
#endif  // ZKX_HLO_ANALYSIS_HLO_ORDERING_H_
