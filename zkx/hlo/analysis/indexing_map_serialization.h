...
#ifndef ZKX_HLO_ANALYSIS_INDEXING_MAP_SERIALIZATION_H_
#define ZKX_HLO_ANALYSIS_INDEXING_MAP_SERIALIZATION_H_
...
#endif  // ZKX_HLO_ANALYSIS_INDEXING_MAP_SERIALIZATION_H_
