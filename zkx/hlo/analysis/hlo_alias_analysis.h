...
#ifndef ZKX_HLO_ANALYSIS_HLO_ALIAS_ANALYSIS_H_
#define ZKX_HLO_ANALYSIS_HLO_ALIAS_ANALYSIS_H_
...
class HloAliasAnalysis {
 public:
  ...
  // (FlattenCallGraph) prior to running the analysis.
  ...
  // Return a vector of all HloBuffers stably sorted by HloBuffer::Id. This
...
#endif  // ZKX_HLO_ANALYSIS_HLO_ALIAS_ANALYSIS_H_
