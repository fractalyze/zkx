...
#ifndef ZKX_HLO_TRANSLATE_MHLO_TO_HLO_STACK_FRAME_INDEX_BUILDER_H_
#define ZKX_HLO_TRANSLATE_MHLO_TO_HLO_STACK_FRAME_INDEX_BUILDER_H_
...
class StackFrameIndexBuilder {
 public:
  ...
  zkx::StackFrameIndexProto Build() const;
 ...
 private:
  ...
  zkx::StackFrameIndexProto indexes_;
...
#endif  // ZKX_HLO_TRANSLATE_MHLO_TO_HLO_STACK_FRAME_INDEX_BUILDER_H_
