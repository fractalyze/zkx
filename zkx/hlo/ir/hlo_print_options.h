...
// has built up via the ZKX service interface. They are ultimately lowered
// in a platform-aware way by traversing the HLO DAG and emitting a lowered
// form; e.g. see DfsHloVisitor.

#ifndef ZKX_HLO_IR_HLO_PRINT_OPTIONS_H_
#define ZKX_HLO_IR_HLO_PRINT_OPTIONS_H_
...
class HloPrintOptions {
 public:
  ...
  // HloModule Module
  //
  // %AsyncOp (p0.1: u32[10]) -> u32[20] {
  //   %p0.1 = u32[10]{0} parameter(0)
  //   ROOT %custom-call = u32[20]{0} custom-call(u32[10]{0} %p0.1),
  //                                  custom_call_target="foo"
  // }
  //
  // ENTRY %Entry (p0: u32[10]) -> u32[20] {
  //   %p0 = u32[10]{0} parameter(0)
  //   %async-start = ((u32[10]{0}), u32[20]{0}, s32[]) async-start(%p0),
  //                                                    calls=%AsyncOp
  //   %async-update = ((u32[10]{0}), u32[20]{0}, s32[]) async-update(
  //                                                         %async-start),
  //                                                     calls=%AsyncOp
  //   ROOT %async-done = u32[20]{0} async-done(%async-update), calls=%AsyncOp
  // }
  //
  ...
  // ENTRY %Entry (p0: u32[10]) -> u32[20] {
  //   %p0 = u32[10]{0} parameter(0)
  //   %async-start = ((u32[10]{0}), u32[20]{0}, s32[]) custom-call-start(%p0),
  //                                                    custom_call_target="foo"
  //   %async-update = ((u32[10]{0}), u32[20]{0}, s32[]) custom-call-update(
  //                                                         %async-start),
  //                                                    custom_call_target="foo"
  //   ROOT %async-done = u32[20]{0} custom-call-done(%async-update),
  //                                                    custom_call_target="foo"
  // }
...
#endif  // ZKX_HLO_IR_HLO_PRINT_OPTIONS_H_
