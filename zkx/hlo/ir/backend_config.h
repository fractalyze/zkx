...
#ifndef ZKX_HLO_IR_BACKEND_CONFIG_H_
#define ZKX_HLO_IR_BACKEND_CONFIG_H_
...
class BackendConfigWrapper {
 ...
 private:
  ...
  mutable std::unique_ptr<google::protobuf::Message> proto_
...
#endif  // ZKX_HLO_IR_BACKEND_CONFIG_H_
