...
#ifndef ZKX_HLO_IR_DYNAMIC_PARAMETER_BINDING_H_
#define ZKX_HLO_IR_DYNAMIC_PARAMETER_BINDING_H_
...
class DynamicParameterBinding {
 public:
  ...
  struct DynamicDimension {
    ...
    // The "friend" keyword is used so that these functions can be found by ADL.
    template <typename H>
...
#endif  // ZKX_HLO_IR_DYNAMIC_PARAMETER_BINDING_H_
