...
#ifndef ZKX_HLO_IR_HLO_SHARDING_METADATA_H_
#define ZKX_HLO_IR_HLO_SHARDING_METADATA_H_
...
class ShardingMetadata : public DomainMetadata {
 public:
  ...
  std::string_view Kind() const override { return KindName(); }
  ...
  static std::string_view KindName() { return "sharding"; }
...
#endif  // ZKX_HLO_IR_HLO_SHARDING_METADATA_H_
