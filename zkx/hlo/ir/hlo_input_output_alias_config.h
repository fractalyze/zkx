...
#ifndef ZKX_HLO_IR_HLO_INPUT_OUTPUT_ALIAS_CONFIG_H_
#define ZKX_HLO_IR_HLO_INPUT_OUTPUT_ALIAS_CONFIG_H_
...
class HloInputOutputAliasConfig {
 public:
  ...
  const Shape& shape() const { return alias_.shape(); }
...
#endif  // ZKX_HLO_IR_HLO_INPUT_OUTPUT_ALIAS_CONFIG_H_
