...
#ifndef ZKX_HLO_IR_HLO_MODULE_GROUP_H_
#define ZKX_HLO_IR_HLO_MODULE_GROUP_H_
...
class HloModuleGroup {
 public:
  ...
  explicit HloModuleGroup(std::string_view name) : name_(name) {}
  ...
  HloModuleGroup(std::string_view name,
...
#endif  // ZKX_HLO_IR_HLO_MODULE_GROUP_H_
