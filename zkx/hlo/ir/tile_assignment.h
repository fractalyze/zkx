...
#ifndef ZKX_HLO_IR_TILE_ASSIGNMENT_H_
#define ZKX_HLO_IR_TILE_ASSIGNMENT_H_
...
class TileAssignment {
 public:
  ...
  // Returns a tile assignment transposed using the given dimension
  // permutations.
  // REQUIRES: `perm` must a an array of num_dimensions elements,
  // with unique values within [0, num_dimensions).
...
#endif  // ZKX_HLO_IR_TILE_ASSIGNMENT_H_
