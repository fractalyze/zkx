...
#ifndef ZKX_HLO_TRANSFORMS_EXPANDERS_OP_EXPANDER_PASS_H_
#define ZKX_HLO_TRANSFORMS_EXPANDERS_OP_EXPANDER_PASS_H_
...
class OpExpanderPass : public HloModulePass {
 ...
 protected:
  ...
  const HloPredicate extra_filter_;
...
#endif  // ZKX_HLO_TRANSFORMS_EXPANDERS_OP_EXPANDER_PASS_H_
