...
#ifndef ZKX_HLO_TRANSFORMS_HOST_OFFLOAD_LEGALIZE_H_
#define ZKX_HLO_TRANSFORMS_HOST_OFFLOAD_LEGALIZE_H_
...
class HostOffloadLegalize : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "host-offload-legalize"; }
...
#endif  // ZKX_HLO_TRANSFORMS_HOST_OFFLOAD_LEGALIZE_H_
