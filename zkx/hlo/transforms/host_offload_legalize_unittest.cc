...
producing_while_condition {
  producing_condition_param = (s32[], s32[96,8,6,2048,2048]{0,1,2,3,4}) parameter(0)
...
consuming_while_condition {
  consuming_condition_param = (s32[], s32[96,8,6,2048,2048]{0,1,2,3,4}) parameter(0)
...
producing_while_body {
  input_tuple.0 = (s32[], s32[96,8,6,2048,2048]{0,1,2,3,4}) parameter(0)
  current_iteration_index.0 = s32[] get-tuple-element(input_tuple.0), index=0
  data_0.0 = s32[96,8,6,2048,2048]{0,1,2,3,4} get-tuple-element(input_tuple.0), index=1
  constant_0.0 = s32[] constant(0)
  constant_1.0 = s32[] constant(1)
  constant_96 = s32[] constant(96)

  /* Create dummy data used in DUS */
  slice_data_0 = s32[1,8,6,2048,2048]  constant({...})
  ...
  custom_call_0.0 = s32[1,8,6,2048,2048] custom-call(slice_data_0), custom_call_target="MoveToHost"

  dynamic_update_slice_0 = s32[96,8,6,2048,2048]{0,1,2,3,4} dynamic-update-slice(data_0.0, custom_call_0.0, select_result.0, constant_0.0, constant_0.0, constant_0.0, constant_0.0)

  /* Increment iteration index */
  incremented_index.0 = s32[] add(current_iteration_index.0, constant_1.0)
  ROOT tuple_result.0 = (s32[], s32[96,8,6,2048,2048]{0,1,2,3,4}) tuple(incremented_index.0, dynamic_update_slice_0)
}

consuming_while_body {
  input_tuple.1 = (s32[], s32[96,8,6,2048,2048]{0,1,3,2,4}) parameter(0)
  current_iteration_index.1 = s32[] get-tuple-element(input_tuple.1), index=0
  data_0.1 = s32[96,8,6,2048,2048]{0,1,3,2,4} get-tuple-element(input_tuple.1), index=1
  ...
  dynamic_slice_0 = s32[1,8,6,2048,2048] dynamic-slice(data_0.1, select_result.1, constant_0.1, constant_0.1, constant_0.1, constant_0.1), dynamic_slice_sizes={1,8,6,2048,2048}

  /* Annotate DS for offload */
  custom_call_0.1 = s32[1,8,6,2048,2048] custom-call(dynamic_slice_0), custom_call_target="MoveToDevice"

  /* Do some work with the dynamic slice outputs. */
  negate_0 = s32[1,8,6,2048,2048] negate(custom_call_0.1)

  /* Increment iteration index */
  incremented_index.1 = s32[] add(current_iteration_index.1, constant_1.1)
  ROOT tuple_result.1 = (s32[], s32[96,8,6,2048,2048]{0,1,3,2,4}) tuple(incremented_index.1, data_0.1)
}

ENTRY main {
  entry_param_0 = s32[] parameter(0)
  entry_param_1 = s32[] parameter(1)
  entry_param_2 = s32[] parameter(2)
  cs0 = s32[] constant(0)
  broadcast_0 = s32[96,8,6,2048,2048]{0,1,2,3,4} broadcast(cs0), dimensions={}
  constant_s32_0 = s32[] constant(0)
  tuple_for_producing_while = (s32[], s32[96,8,6,2048,2048]{0,1,2,3,4}) tuple(constant_s32_0, broadcast_0)
  producing_while = (s32[], s32[96,8,6,2048,2048]{0,1,2,3,4}) while(tuple_for_producing_while), condition=producing_while_condition, body=producing_while_body
  while_output_1 = s32[96,8,6,2048,2048]{0,1,2,3,4} get-tuple-element(producing_while), index=1
  cp = s32[96,8,6,2048,2048]{0,1,3,2,4} copy(while_output_1)
  tuple_for_consuming_while = (s32[], s32[96,8,6,2048,2048]{0,1,3,2,4}) tuple(constant_s32_0, cp)
  consuming_while = (s32[], s32[96,8,6,2048,2048]{0,1,3,2,4}) while(tuple_for_consuming_while), condition=consuming_while_condition, body=consuming_while_body
  second_while_output = s32[96,8,6,2048,2048]{0,1,3,2,4} get-tuple-element(consuming_while), index=1
  final_dynamic_slice_0 = s32[1,8,6,2048,2048] dynamic-slice(second_while_output, entry_param_1, constant_s32_0, constant_s32_0, constant_s32_0, constant_s32_0), dynamic_slice_sizes={1,8,6,2048,2048}
  final_host_to_device_custom_call_0 = s32[1,8,6,2048,2048] custom-call(final_dynamic_slice_0), custom_call_target="MoveToDevice"
  final_slice_0 = s32[1,8,6,2048,2048] slice(second_while_output), slice={[41:42], [0:8], [0:6], [0:2048], [0:2048]}
  final_host_to_device_custom_call_1 = s32[1,8,6,2048,2048] custom-call(final_slice_0), custom_call_target="MoveToDevice"
  ROOT add = s32[1,8,6,2048,2048] add(final_host_to_device_custom_call_0, final_host_to_device_custom_call_1)
}
)";
...
ENTRY main {
  ...
  while_output_1 = s32[96,8,6,2048,2048]{0,1,2,3,4} get-tuple-element(producing_while), index=1
  cp = s32[96,8,6,2048,2048]{0,1,3,2,4} copy(while_output_1)
  cp1 = s32[96,8,6,2048,2048]{0,1,3,2,4} copy(cp)
  tuple_for_consuming_while = (s32[], s32[96,8,6,2048,2048]{0,1,3,2,4}) tuple(constant_s32_0, cp1)
  consuming_while = (s32[], s32[96,8,6,2048,2048]{0,1,3,2,4}) while(tuple_for_consuming_while), condition=consuming_while_condition, body=consuming_while_body
  second_while_output = s32[96,8,6,2048,2048]{0,1,3,2,4} get-tuple-element(consuming_while), index=1
  final_dynamic_slice_0 = s32[1,8,6,2048,2048] dynamic-slice(second_while_output, entry_param_1, constant_s32_0, constant_s32_0, constant_s32_0, constant_s32_0), dynamic_slice_sizes={1,8,6,2048,2048}
  final_host_to_device_custom_call_0 = s32[1,8,6,2048,2048] custom-call(final_dynamic_slice_0), custom_call_target="MoveToDevice"
