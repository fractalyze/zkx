...
class OptimizeInputOutputBufferAliasTest
 ...
 protected:
  OptimizeInputOutputBufferAliasTest() {
    r1f32_ = ShapeUtil::MakeShape(S32, {4});
    r2f32_ = ShapeUtil::MakeShape(S32, {4, 5});
    r3f32_ = ShapeUtil::MakeShape(S32, {4, 5, 6});
    r4f32_ = ShapeUtil::MakeShape(S32, {4, 5, 6, 7});
    d1f32_ = ShapeUtil::MakeShape(S32, {256}, /*dynamic_dimensions=*/{true});
    d2f32_ = ShapeUtil::MakeShape(S32, {128, 128},
                                  /*dynamic_dimensions=*/{false, true});
    // Static shape with same size as dynamic shape `d1f32_`.
    d3f32_ = ShapeUtil::MakeShape(S32, {512});
  }
