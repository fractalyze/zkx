...
#ifndef ZKX_HLO_TRANSFORMS_SIMPLIFIERS_OPTIMIZE_INPUT_OUTPUT_BUFFER_ALIAS_H_
#define ZKX_HLO_TRANSFORMS_SIMPLIFIERS_OPTIMIZE_INPUT_OUTPUT_BUFFER_ALIAS_H_
...
//
//  Parameters : { P1(s32[3]), P2(s64[3]), P3(s32[3,12]), P4(s32[16,12]), ... }
//  Outputs    : { O1(s64[3]), O2(s32[3]), O3(s32[16,12]), ... }
//
...
#endif  // ZKX_HLO_TRANSFORMS_SIMPLIFIERS_OPTIMIZE_INPUT_OUTPUT_BUFFER_ALIAS_H_
