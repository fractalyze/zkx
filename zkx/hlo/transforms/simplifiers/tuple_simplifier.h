...
#ifndef ZKX_HLO_TRANSFORMS_SIMPLIFIERS_TUPLE_SIMPLIFIER_H_
#define ZKX_HLO_TRANSFORMS_SIMPLIFIERS_TUPLE_SIMPLIFIER_H_
...
class TupleSimplifier : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "tuple-simplifier"; }
...
#endif  // ZKX_HLO_TRANSFORMS_SIMPLIFIERS_TUPLE_SIMPLIFIER_H_
