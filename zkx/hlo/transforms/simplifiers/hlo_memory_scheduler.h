...
#ifndef ZKX_HLO_TRANSFORMS_SIMPLIFIERS_HLO_MEMORY_SCHEDULER_H_
#define ZKX_HLO_TRANSFORMS_SIMPLIFIERS_HLO_MEMORY_SCHEDULER_H_
...
class HloMemoryScheduler : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "hlo-memory-scheduler"; }
...
class HloTrivialScheduler : public HloModulePass {
 public:
  std::string_view name() const override { return "hlo-trivial-scheduler"; }
...
class HloDescheduler : public HloModulePass {
 public:
  ...
  std::string_view name() const override { return "hlo-descheduler"; }
...
#endif  // ZKX_HLO_TRANSFORMS_SIMPLIFIERS_HLO_MEMORY_SCHEDULER_H_
