...
#ifndef ZKX_HLO_TRANSFORMS_SIMPLIFIERS_FLATTEN_CALL_GRAPH_H_
#define ZKX_HLO_TRANSFORMS_SIMPLIFIERS_FLATTEN_CALL_GRAPH_H_
...
class FlattenCallGraph : public HloModulePass {
 public:
  std::string_view name() const override { return "flatten-call-graph"; }
...
#endif  // ZKX_HLO_TRANSFORMS_SIMPLIFIERS_FLATTEN_CALL_GRAPH_H_
