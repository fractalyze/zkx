...
class FlattenCallGraphTest : public HloHardwareIndependentTestBase {
 protected:
  ...
  const Shape kScalarShape = ShapeUtil::MakeShape(S32, {});
};
...
TEST_F(FlattenCallGraphTest, FlattenCallsInConditional) {
  ...
  auto constant1 = builder.AddInstruction(
      HloInstruction::CreateConstant(LiteralUtil::CreateR0<int32_t>(56)));
  auto constant2 = builder.AddInstruction(
      HloInstruction::CreateConstant(LiteralUtil::CreateR0<int32_t>(12)));
...
%called_computation (param_0: s32[4096], param_1: s32[4096]) -> s32[4096] {
  %param_0 = s32[4096]{0} parameter(0)
  %param_1 = s32[4096]{0} parameter(1)
  ROOT %result.1 = s32[4096]{0} add(s32[4096]{0} %param_0, s32[4096]{0} %param_1)
}

ENTRY %main (a: s32[4096], b: s32[4096]) -> s32[4096] {
  %a = s32[4096]{0} parameter(0)
  %b = s32[4096]{0} parameter(1)
  %call-start.0 = ((s32[4096]{0}, s32[4096]{0}), s32[4096]{0}, u32[]) call-start(s32[4096]{0} %a, s32[4096]{0} %b), to_apply=%called_computation
  %call-done.0 = s32[4096]{0} call-done(((s32[4096]{0}, s32[4096]{0}), s32[4096]{0}, u32[]) %call-start.0)
  %call-start.1 = ((s32[4096]{0}, s32[4096]{0}), s32[4096]{0}, u32[]) call-start(s32[4096]{0} %call-done.0, s32[4096]{0} %b), to_apply=%called_computation
  %call-done.1 = s32[4096]{0} call-done(((s32[4096]{0}, s32[4096]{0}), s32[4096]{0}, u32[]) %call-start.1)
  ROOT %add_1 = s32[4096]{0} add(s32[4096]{0} %a, s32[4096]{0} %call-done.1)
}
  )";
