...
#ifndef ZKX_HLO_PARSER_HLO_PARSER_H_
#define ZKX_HLO_PARSER_HLO_PARSER_H_
...
absl::StatusOr<std::unique_ptr<HloModule>> ParseAndReturnUnverifiedModule(
    std::string_view str, const HloModuleConfig& config = HloModuleConfig(),
...
#endif  // ZKX_HLO_PARSER_HLO_PARSER_H_
