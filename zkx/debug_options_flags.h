...
// pass has by specifying ZKX_FLAGS=--zkx_fuel=PASS1=NUM1,PASS2=NUM2,...
//
// If a user specifies --zkx_fuel=PASS=NUM but ConsumeFuel(PASS) is not called
...
bool ConsumeFuel(std::string_view pass, bool* just_ran_out = nullptr);
...
bool ConsumeFuel(std::string_view pass,
