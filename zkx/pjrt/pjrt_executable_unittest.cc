...
// clang-format off
// TODO(chokobole): Uncomment this. Dependency: DebugOptions::zkx_gpu_use_runtime_fusion
// clang-format on
...
//       {"zkx_gpu_use_runtime_fusion", std::string("True")},
//       {"zkx_gpu_graph_min_graph_size", std::string("2")},
//       {"zkx_gpu_disable_async_collectives", std::string("2")},
//       {"zkx_gpu_redzone_scratch_max_megabytes", std::string("3400")},
//       {"zkx_gpu_auto_spmd_partitioning_memory_budget_ratio", 0.9},
//       {"zkx_gpu_pgle_profile_file_or_directory_path", std::string("abc")}};
//   CompileOptions src;
...
//   EXPECT_EQ(debug_options.zkx_gpu_use_runtime_fusion(), true);
//   EXPECT_EQ(debug_options.zkx_gpu_graph_min_graph_size(), 2);
//   EXPECT_EQ(debug_options.zkx_gpu_redzone_scratch_max_megabytes(), 3400);
//   EXPECT_FLOAT_EQ(
//       debug_options.zkx_gpu_auto_spmd_partitioning_memory_budget_ratio(),
//       0.9);
//   EXPECT_EQ(debug_options.zkx_gpu_pgle_profile_file_or_directory_path(),
//   "abc");
//   EXPECT_EQ(debug_options.zkx_gpu_disable_async_collectives().size(), 1);
//   EXPECT_EQ(debug_options.zkx_gpu_disable_async_collectives()[0], 2);
// }
