...
#ifndef ZKX_PJRT_PJRT_DEVICE_DESCRIPTION_H_
#define ZKX_PJRT_PJRT_DEVICE_DESCRIPTION_H_
...
class PjRtMemorySpaceDescription {
 public:
  PjRtMemorySpaceDescription(std::string_view kind, int kind_id)
...
#endif  // ZKX_PJRT_PJRT_DEVICE_DESCRIPTION_H_
