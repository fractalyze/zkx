...
#ifndef ZKX_PJRT_TRANSPOSE_KERNELS_H_
#define ZKX_PJRT_TRANSPOSE_KERNELS_H_
...
#include "zkx/compiler_macros.h"

#ifdef ZKX_HAS_SSE2
#include <immintrin.h>  // IWYU pragma: keep
#endif

#ifdef ZKX_HAS_ARM_NEON
#include <arm_neon.h>
#endif  // ZKX_HAS_ARM_NEON

#if defined(ZKX_HAS_SSE2) || defined(ZKX_HAS_ARM_NEON)
#define ZKX_HAS_VEC128
#endif  // defined(ZKX_HAS_SSE2) || defined(ZKX_HAS_ARM_NEON)
...
struct Vec128RectangularTransposeMicroKernelImpl {
  ZKX_FLATTEN static void Apply(const char* __restrict a, int64_t lda,
...
#endif  // ZKX_PJRT_TRANSPOSE_KERNELS_H_
