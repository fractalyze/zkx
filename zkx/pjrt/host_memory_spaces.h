...
#ifndef ZKX_PJRT_HOST_MEMORY_SPACES_H_
#define ZKX_PJRT_HOST_MEMORY_SPACES_H_
...
class UnpinnedHostMemorySpace : public PjRtMemorySpace {
 public:
  static constexpr std::string_view kKind = "unpinned_host";
...
class PinnedHostMemorySpace : public PjRtMemorySpace {
 public:
  static constexpr std::string_view kKind = "pinned_host";
  static const int kKindId;
...
#endif  // ZKX_PJRT_HOST_MEMORY_SPACES_H_
