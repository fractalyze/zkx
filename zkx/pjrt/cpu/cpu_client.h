...
#ifndef ZKX_PJRT_CPU_CPU_CLIENT_H_
#define ZKX_PJRT_CPU_CPU_CLIENT_H_
...
#include "zkx/pjrt/cpu/abstract_tfrt_cpu_buffer.h"
#include "zkx/pjrt/cpu/cpu_device.h"
...
class TfrtCpuClient final : public PjRtClient {
 public:
  ...
  std::string_view platform_name() const override { return CpuName(); }

  std::string_view platform_version() const override { return CpuName(); }
  ...
  MakeCrossHostReceiveBuffers(absl::Span<const Shape> shapes,
    ...
    return absl::UnimplementedError(
        "MakeCrossHostReceiveBuffers not implemented.");
  }
  ...
  absl::Status Defragment() override {
    return absl::UnimplementedError("Defragment not implemented.");
  }
 ...
 private:
  ...
  // TODO(yueshengys): Consider moving the enqueuing/ordering logic to ZKX via
  // token threading.
...
class TfrtCpuExecutable final : public PjRtLoadedExecutable {
 public:
  ...
  absl::StatusOr<CompiledMemoryStats> GetCompiledMemoryStats() const override {
    ...
    // TODO(chokobole): Uncomment this. Dependency: Executable::HloProto
    // const HloProto* proto = cpu_executable_->hlo_proto();
    // if (!proto) {
    //   return absl::FailedPreconditionError("cpu_executable_ has no
    //   hlo_proto.");
    // }
...
#endif  // ZKX_PJRT_CPU_CPU_CLIENT_H_
