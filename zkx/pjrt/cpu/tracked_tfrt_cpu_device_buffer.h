...
#ifndef ZKX_PJRT_CPU_TRACKED_TFRT_CPU_DEVICE_BUFFER_H_
#define ZKX_PJRT_CPU_TRACKED_TFRT_CPU_DEVICE_BUFFER_H_
  ...
  static absl::StatusOr<MaybeOwningCpuMemory> Allocate(size_t size) {
    ...
    if (!data) {
      return absl::ResourceExhaustedError(
          absl::StrFormat("Out of memory allocating %d bytes.", size));
    }
...
#endif  // ZKX_PJRT_CPU_TRACKED_TFRT_CPU_DEVICE_BUFFER_H_
