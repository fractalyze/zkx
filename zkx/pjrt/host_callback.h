...
#ifndef ZKX_PJRT_HOST_CALLBACK_H_
#define ZKX_PJRT_HOST_CALLBACK_H_
...
// PjRT's send/recv interface (see zkx::SendCallback and zkx::RecvCallback).
...
#endif  // ZKX_PJRT_HOST_CALLBACK_H_
