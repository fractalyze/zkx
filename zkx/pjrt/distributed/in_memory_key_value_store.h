...
#ifndef ZKX_PJRT_DISTRIBUTED_IN_MEMORY_KEY_VALUE_STORE_H_
#define ZKX_PJRT_DISTRIBUTED_IN_MEMORY_KEY_VALUE_STORE_H_
...
#endif  // ZKX_PJRT_DISTRIBUTED_IN_MEMORY_KEY_VALUE_STORE_H_
