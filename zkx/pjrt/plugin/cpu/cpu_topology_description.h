...
#ifndef ZKX_PJRT_PLUGIN_CPU_CPU_TOPOLOGY_DESCRIPTION_H_
#define ZKX_PJRT_PLUGIN_CPU_CPU_TOPOLOGY_DESCRIPTION_H_
...
#include "zkx/pjrt/plugin/cpu/cpu_topology.h"
...
class CpuTopologyDescription : public PjRtTopologyDescription {
 public:
  ...
  CpuTopologyDescription(const PjRtPlatformId platform_id,
                         ...
                         const std::string_view platform_version,
  ...
  bool operator==(const CpuTopologyDescription& other) const {
    return platform_id() == other.platform_id() &&
           ...
           cpu_topology().devices() == other.cpu_topology().devices();
  }
...
#endif  // ZKX_PJRT_PLUGIN_CPU_CPU_TOPOLOGY_DESCRIPTION_H_
