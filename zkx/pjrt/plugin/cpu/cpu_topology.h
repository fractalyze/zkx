...
#ifndef ZKX_PJRT_PLUGIN_CPU_CPU_TOPOLOGY_H_
#define ZKX_PJRT_PLUGIN_CPU_CPU_TOPOLOGY_H_
...
#include "zkx/pjrt/plugin/cpu/cpu_topology.pb.h"
...
#endif  // ZKX_PJRT_PLUGIN_CPU_CPU_TOPOLOGY_H_
