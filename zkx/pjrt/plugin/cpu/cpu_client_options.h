...
#ifndef ZKX_PJRT_PLUGIN_CPU_CPU_CLIENT_OPTIONS_H_
#define ZKX_PJRT_PLUGIN_CPU_CPU_CLIENT_OPTIONS_H_
...
struct CpuClientOptions {
  ...
  // --zkx_force_host_platform_device_count is used.
...
#endif  // ZKX_PJRT_PLUGIN_CPU_CPU_CLIENT_OPTIONS_H_
