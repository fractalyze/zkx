...
//   - Untouched: There is a 1:1 correspondence between an operand and a result
//     shape dimension.
//
...
// be included in the dimension group. This is useful iff they are "unpaired",
...
SmallVector<int64_t>
concretizeOperandShape(ArrayRef<int64_t> operandShape,
                       ArrayRef<SymbolicExpr> operandShapeInfo) {
...
LogicalResult materializeReshapeAsExpandAndCollapse(
    ...
    PatternRewriter &rewriter) {
  // Require successful shape analysis for operand and result shape.
