...
#ifndef ZKX_MLIR_HLO_STABLEHLO_DIALECT_VERSION_H_
#define ZKX_MLIR_HLO_STABLEHLO_DIALECT_VERSION_H_
...
class Version {
 public:
  ...
  static Version getCurrentVersion() { return Version(0, 0, 1); }

  // Return a Version representing the minimum supported VHLO dialect version.
  static Version getMinimumVersion() { return Version(0, 0, 1); }
