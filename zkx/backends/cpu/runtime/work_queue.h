...
#ifndef ZKX_BACKENDS_CPU_RUNTIME_WORK_QUEUE_H_
#define ZKX_BACKENDS_CPU_RUNTIME_WORK_QUEUE_H_
 ...
 public:
  WorkQueue(size_t num_tasks, size_t num_partitions)
    ...
    size_t partition_size =
        tsl::MathUtil::CeilOfRatio(num_tasks, num_partitions);
...
#endif  // ZKX_BACKENDS_CPU_RUNTIME_WORK_QUEUE_H_
