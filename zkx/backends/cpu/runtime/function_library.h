...
#ifndef ZKX_BACKENDS_CPU_RUNTIME_FUNCTION_LIBRARY_H_
#define ZKX_BACKENDS_CPU_RUNTIME_FUNCTION_LIBRARY_H_
...
#endif  // ZKX_BACKENDS_CPU_RUNTIME_FUNCTION_LIBRARY_H_
