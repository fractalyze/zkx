...
#ifndef ZKX_BACKENDS_CPU_RUNTIME_COLLECTIVE_THUNK_H_
#define ZKX_BACKENDS_CPU_RUNTIME_COLLECTIVE_THUNK_H_
...
class CollectiveThunk : public Thunk {
 ...
 public:
  ...
  static absl::Duration DefaultCollectiveTimeout() { return absl::Minutes(30); }

  absl::StatusOr<RendezvousKey> GetRendezvousKey(
      const Thunk::CollectiveExecuteParams& params);

  static absl::StatusOr<int32_t> RankInGlobalDevices(const RendezvousKey& key,
                                                     GlobalDeviceId device);

  // TODO(chokobole): If Thunk::OkExecuteEvent() does not rely on instance
  // members, consider making it static.
...
#endif  // ZKX_BACKENDS_CPU_RUNTIME_COLLECTIVE_THUNK_H_
