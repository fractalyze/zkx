...
#ifndef ZKX_BACKENDS_CPU_RUNTIME_KERNEL_THUNK_H_
#define ZKX_BACKENDS_CPU_RUNTIME_KERNEL_THUNK_H_
...
class KernelThunk : public KernelThunkBase {
 public:
  ...
  std::string_view kernel_name() const final { return kernel_name_; }
 ...
 private:
  friend class ::zkx::cpu::KernelThunk;
  ...
  using KernelArgs = std::conditional_t<
      ...
      absl::InlinedVector<ZKX_CPU_KernelArg, 8>,
      std::array<ZKX_CPU_KernelArg, Size(num_arguments + num_results)>>;
...
#endif  // ZKX_BACKENDS_CPU_RUNTIME_KERNEL_THUNK_H_
