...
#ifndef ZKX_BACKENDS_CPU_RUNTIME_RESOURCE_USE_H_
#define ZKX_BACKENDS_CPU_RUNTIME_RESOURCE_USE_H_
...
class Resource {
 public:
  enum class Kind {
    ...
    // TODO(chokobole): Update the comment below if we decide to name our module
    // something other than HLO.
...
#endif  // ZKX_BACKENDS_CPU_RUNTIME_RESOURCE_USE_H_
