...
#ifndef ZKX_BACKENDS_CPU_RUNTIME_CONDITIONAL_THUNK_H_
#define ZKX_BACKENDS_CPU_RUNTIME_CONDITIONAL_THUNK_H_
...
#endif  // ZKX_BACKENDS_CPU_RUNTIME_CONDITIONAL_THUNK_H_
