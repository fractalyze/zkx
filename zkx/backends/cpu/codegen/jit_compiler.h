...
#ifndef ZKX_BACKENDS_CPU_CODEGEN_JIT_COMPILER_H_
#define ZKX_BACKENDS_CPU_CODEGEN_JIT_COMPILER_H_
...
#include "zkx/backends/cpu/codegen/execution_engine.h"
#include "zkx/backends/cpu/codegen/ir_compiler.h"
...
// optimized for compiling LLVM modules produced by ZKX:CPU. LLVM itself
...
class JitCompiler {
 public:
  ...
  struct Options {
    ...
    // We compile ZKX:CPU program into multiple LLVM modules, and by using
    ...
    // Maximum CPU instruction set for which the compiler should generate code.
...
#endif  // ZKX_BACKENDS_CPU_CODEGEN_JIT_COMPILER_H_
