...
#ifndef ZKX_BACKENDS_CPU_CODEGEN_OBJECT_LOADER_H_
#define ZKX_BACKENDS_CPU_CODEGEN_OBJECT_LOADER_H_
...
#include "zkx/backends/cpu/codegen/compiled_function_library.h"
...
class ObjectLoader {
 ...
 private:
  std::function<std::string(std::string_view)> GetMangler();
...
#endif  // ZKX_BACKENDS_CPU_CODEGEN_OBJECT_LOADER_H_
