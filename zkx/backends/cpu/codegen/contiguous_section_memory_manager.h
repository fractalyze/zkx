...
#ifndef ZKX_BACKENDS_CPU_CODEGEN_CONTIGUOUS_SECTION_MEMORY_MANAGER_H_
#define ZKX_BACKENDS_CPU_CODEGEN_CONTIGUOUS_SECTION_MEMORY_MANAGER_H_
...
#endif  // ZKX_BACKENDS_CPU_CODEGEN_CONTIGUOUS_SECTION_MEMORY_MANAGER_H_
