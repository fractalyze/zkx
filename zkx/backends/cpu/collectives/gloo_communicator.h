...
#ifndef ZKX_BACKENDS_CPU_COLLECTIVES_GLOO_COMMUNICATOR_H_
#define ZKX_BACKENDS_CPU_COLLECTIVES_GLOO_COMMUNICATOR_H_
...
// ZKX communicator implemented using Gloo communication library.
class GlooCommunicator : public Communicator {
 public:
  ...
  ~GlooCommunicator() override = default;
  ...
  absl::Status Broadcast(se::DeviceMemoryBase, se::DeviceMemoryBase,
    ...
    return absl::UnimplementedError("Broadcast is not implemented");
  }
...
#endif  // ZKX_BACKENDS_CPU_COLLECTIVES_GLOO_COMMUNICATOR_H_
