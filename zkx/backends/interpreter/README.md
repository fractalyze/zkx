# ZKX Interpreter Backend

The ZKX Interpreter backend operates at HLO-level by ingesting a HloModule and
...
- \[`InterpreterCompiler`\] despite the inherited naming of "compiler", all
  ...
  1. Generates an `InterpreterExecutable` from the optimized HLO graph.
  1. Registers itself in the global compiler factory registry.
