...
// Declares the ZkxInterpreterExecutor class, which is a CPU-only implementation
// of the StreamExecutor interface. For now, this is used for testing and to
// examine the performance of host-based StreamExecutor code.
#ifndef ZKX_BACKENDS_INTERPRETER_EXECUTOR_H_
#define ZKX_BACKENDS_INTERPRETER_EXECUTOR_H_
...
class ZkxInterpreterExecutor : public StreamExecutorCommon {
 public:
  ZkxInterpreterExecutor(int device_ordinal, Platform *platform)
...
#endif  // ZKX_BACKENDS_INTERPRETER_EXECUTOR_H_
