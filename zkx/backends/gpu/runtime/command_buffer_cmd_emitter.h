...
#ifndef ZKX_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_EMITTER_H_
#define ZKX_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_EMITTER_H_
...
#endif  // ZKX_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_EMITTER_H_
