...
#ifndef ZKX_BACKENDS_GPU_RUNTIME_WAIT_FOR_STREAMS_THUNK_H_
#define ZKX_BACKENDS_GPU_RUNTIME_WAIT_FOR_STREAMS_THUNK_H_
...
#endif  // ZKX_BACKENDS_GPU_RUNTIME_WAIT_FOR_STREAMS_THUNK_H_
