...
#ifndef ZKX_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_H_
#define ZKX_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_H_
...
class CommandBufferCmd {
 public:
  ...
  // See Thunk documentation for ZKX execution stages (prepare, initialize,
...
class CommandBufferCmdSequence {
 public:
  ...
  // a single execution scope (corresponds to execution stream).
...
// subsequent calls to ZKX executable tend to reuse the same allocations.
...
#endif  // ZKX_BACKENDS_GPU_RUNTIME_COMMAND_BUFFER_CMD_H_
