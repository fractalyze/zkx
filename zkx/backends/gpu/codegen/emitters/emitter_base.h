...
==============================================================================*/
#ifndef ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_EMITTER_BASE_H_
#define ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_EMITTER_BASE_H_
...
#include "zkx/mlir/tools/mlir_replay/public/compiler_trace.pb.h"
...
class EmitterBase : public KernelFusionInterface {
 ...
 private:
  ...
  // The fusion outputs may only be used with `tensor.insert` ops.
...
// Adds passes that transform ZKX_GPU and SCF loops, e.g. peel, pipeline,
// vectorize.
...
#endif  // ZKX_BACKENDS_GPU_CODEGEN_EMITTERS_EMITTER_BASE_H_
