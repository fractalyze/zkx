...
#ifndef ZKX_BACKENDS_GPU_CODEGEN_EXT_FIELD_TEST_H_
#define ZKX_BACKENDS_GPU_CODEGEN_EXT_FIELD_TEST_H_
...
template <typename F>
class ExtFieldScalarBinaryTest : public CudaKernelEmitterTest {
 public:
  void SetUp() override {
...
template <typename F>
class ExtFieldScalarTernaryTest : public CudaKernelEmitterTest {
 public:
  void SetUp() override {
    CudaKernelEmitterTest::SetUp();
    x_typename_ = primitive_util::LowercasePrimitiveTypeName(
...
template <typename F>
class ExtFieldR2TensorBinaryTest : public CudaKernelEmitterTest {
 public:
...
#endif  // ZKX_BACKENDS_GPU_CODEGEN_EXT_FIELD_TEST_H_
