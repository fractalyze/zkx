...
#include "zkx/backends/gpu/codegen/ext_field_test.h"
...
TYPED_TEST_SUITE(ExtFieldR2TensorBinaryTest, ExtensionFieldTypes);

TYPED_TEST(ExtFieldR2TensorBinaryTest, Add) {
  this->SetUpAdd();
  this->RunAndVerify();
}
