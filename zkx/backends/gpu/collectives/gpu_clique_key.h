...
#ifndef ZKX_BACKENDS_GPU_COLLECTIVES_GPU_CLIQUE_KEY_H_
#define ZKX_BACKENDS_GPU_COLLECTIVES_GPU_CLIQUE_KEY_H_
...
// In ZKX:GPU we use different streams for different kinds of collective
...
#endif  // ZKX_BACKENDS_GPU_COLLECTIVES_GPU_CLIQUE_KEY_H_
