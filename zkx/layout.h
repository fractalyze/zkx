...
#ifndef ZKX_LAYOUT_H_
#define ZKX_LAYOUT_H_
...
// https://openxla.org/xla/tiled_layout for details.
class Tile {
 public:
  Tile() = default;
...
class Layout {
 ...
 private:
  ...
  //
  // For example, in shape u32[8,100,100,3]{3,0,2,1}, the logical dimensions
