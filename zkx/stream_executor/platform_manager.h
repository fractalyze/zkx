...
#ifndef ZKX_STREAM_EXECUTOR_PLATFORM_MANAGER_H_
#define ZKX_STREAM_EXECUTOR_PLATFORM_MANAGER_H_
...
class PlatformManager {
 public:
  ...
  static absl::StatusOr<Platform*> PlatformWithName(std::string_view target);
...
#endif  // ZKX_STREAM_EXECUTOR_PLATFORM_MANAGER_H_
