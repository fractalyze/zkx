...
#ifndef ZKX_STREAM_EXECUTOR_HOST_HOST_PLATFORM_ID_H_
#define ZKX_STREAM_EXECUTOR_HOST_HOST_PLATFORM_ID_H_
...
#endif  // ZKX_STREAM_EXECUTOR_HOST_HOST_PLATFORM_ID_H_
