...
#ifndef ZKX_STREAM_EXECUTOR_ROCM_ROCM_PLATFORM_ID_H_
#define ZKX_STREAM_EXECUTOR_ROCM_ROCM_PLATFORM_ID_H_
...
#endif  // ZKX_STREAM_EXECUTOR_ROCM_ROCM_PLATFORM_ID_H_
