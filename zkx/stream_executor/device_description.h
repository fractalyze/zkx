...
#ifndef ZKX_STREAM_EXECUTOR_DEVICE_DESCRIPTION_H_
#define ZKX_STREAM_EXECUTOR_DEVICE_DESCRIPTION_H_
...
class RocmComputeCapability {
 public:
  ...
  bool has_amd_matrix_core() const {
    return (gfx9_mi100_or_later() || (gfx_version_.find("gfx11") == 0) ||
            (gfx_version_.find("gfx12") == 0));
  }
...
#endif  // ZKX_STREAM_EXECUTOR_DEVICE_DESCRIPTION_H_
