...
#ifndef ZKX_STREAM_EXECUTOR_GENERIC_MEMORY_ALLOCATION_H_
#define ZKX_STREAM_EXECUTOR_GENERIC_MEMORY_ALLOCATION_H_
...
#endif  // ZKX_STREAM_EXECUTOR_GENERIC_MEMORY_ALLOCATION_H_
