...
#ifndef ZKX_STREAM_EXECUTOR_DEVICE_MEMORY_ALLOCATOR_H_
#define ZKX_STREAM_EXECUTOR_DEVICE_MEMORY_ALLOCATOR_H_
...
#endif  // ZKX_STREAM_EXECUTOR_DEVICE_MEMORY_ALLOCATOR_H_
