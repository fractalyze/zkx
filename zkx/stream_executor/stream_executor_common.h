...
#ifndef ZKX_STREAM_EXECUTOR_STREAM_EXECUTOR_COMMON_H_
#define ZKX_STREAM_EXECUTOR_STREAM_EXECUTOR_COMMON_H_
...
#endif  // ZKX_STREAM_EXECUTOR_STREAM_EXECUTOR_COMMON_H_
