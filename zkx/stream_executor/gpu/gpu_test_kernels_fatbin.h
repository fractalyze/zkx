...
#ifndef ZKX_STREAM_EXECUTOR_GPU_GPU_TEST_KERNELS_FATBIN_H_
#define ZKX_STREAM_EXECUTOR_GPU_GPU_TEST_KERNELS_FATBIN_H_
...
#endif  // ZKX_STREAM_EXECUTOR_GPU_GPU_TEST_KERNELS_FATBIN_H_
