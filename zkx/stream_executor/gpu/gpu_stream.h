...
#ifndef ZKX_STREAM_EXECUTOR_GPU_GPU_STREAM_H_
#define ZKX_STREAM_EXECUTOR_GPU_GPU_STREAM_H_

#include "zkx/stream_executor/gpu/gpu_types.h"
...
#endif  // ZKX_STREAM_EXECUTOR_GPU_GPU_STREAM_H_
