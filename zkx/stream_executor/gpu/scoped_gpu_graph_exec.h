...
#ifndef ZKX_STREAM_EXECUTOR_GPU_SCOPED_GPU_GRAPH_EXEC_H_
#define ZKX_STREAM_EXECUTOR_GPU_SCOPED_GPU_GRAPH_EXEC_H_
...
class ScopedGraphExec : public ScopedUpdateMode {
 ...
 private:
  GraphExecHandle* restore_location_;  // not owned
  bool* restore_is_owned_location_;
  GraphExecHandle restore_value_;  // not owned
  bool restore_is_owned_value_;
};

}  // namespace stream_executor::gpu

#endif  // ZKX_STREAM_EXECUTOR_GPU_SCOPED_GPU_GRAPH_EXEC_H_
