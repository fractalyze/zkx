...
#ifndef ZKX_STREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
#define ZKX_STREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
...
#endif  // ZKX_STREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
