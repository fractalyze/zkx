...
#ifndef ZKX_STREAM_EXECUTOR_COMMAND_BUFFER_H_
#define ZKX_STREAM_EXECUTOR_COMMAND_BUFFER_H_
...
class CommandBuffer {
 public:
  ...
  //   (3) There is no synchronization between execution scopes, and commands
  ...
  //   (4) All commands before a shared barrier (in both execution scopes)
  //       should complete before any command after a barrier starts execution.
  //
  //
  //
...
#endif  // ZKX_STREAM_EXECUTOR_COMMAND_BUFFER_H_
