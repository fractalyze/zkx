...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_COMPILATION_PROVIDER_H_
#define ZKX_STREAM_EXECUTOR_CUDA_COMPILATION_PROVIDER_H_
...
class CompilationProvider {
 public:
  ...
  // providers, this function will return false. Any calls to
  // `CompileToRelocatableModule` will result in an error. `CompileAndLink` can
  // be used instead, but it doesn't allow for separate (parallel) compilation
  // of multiple modules.
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_COMPILATION_PROVIDER_H_
