...
absl::StatusOr<Assembly> NvJitLinkCompilationProvider::Compile(
...
NvJitLinkCompilationProvider::CompileToRelocatableModule(
    const CudaComputeCapability& cc, std::string_view ptx,
    const CompilationOptions& options) const {
...
absl::StatusOr<Assembly> NvJitLinkCompilationProvider::CompileAndLink(
