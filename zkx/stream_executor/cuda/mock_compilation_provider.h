...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_MOCK_COMPILATION_PROVIDER_H_
#define ZKX_STREAM_EXECUTOR_CUDA_MOCK_COMPILATION_PROVIDER_H_
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_MOCK_COMPILATION_PROVIDER_H_
