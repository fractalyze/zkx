...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_CUDA_COMMAND_BUFFER_H_
#define ZKX_STREAM_EXECUTOR_CUDA_CUDA_COMMAND_BUFFER_H_
...
#include "zkx/stream_executor/bit_pattern.h"
...
#include "zkx/stream_executor/gpu/scoped_gpu_graph_exec.h"
#include "zkx/stream_executor/gpu/scoped_update_mode.h"
...
class CudaCommandBuffer final : public GpuCommandBuffer {
 ...
 private:
  ...
  absl::Status WriteGraphToDotFile(std::string_view path) override;
  ...
  CudaContext* cuda_context_;  // not owned
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_CUDA_COMMAND_BUFFER_H_
