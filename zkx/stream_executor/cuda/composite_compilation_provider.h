...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_COMPOSITE_COMPILATION_PROVIDER_H_
#define ZKX_STREAM_EXECUTOR_CUDA_COMPOSITE_COMPILATION_PROVIDER_H_
...
class CompositeCompilationProvider : public CompilationProvider {
 ...
 private:
  ...
  CompilationProvider* relocatable_compilation_provider_ =
      nullptr;  // not owned
  CompilationProvider* compile_and_link_compilation_provider_ =
      nullptr;  // not owned
};

}  // namespace stream_executor::cuda

#endif  // ZKX_STREAM_EXECUTOR_CUDA_COMPOSITE_COMPILATION_PROVIDER_H_
