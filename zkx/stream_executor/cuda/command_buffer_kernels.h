...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_COMMAND_BUFFER_KERNELS_H_
#define ZKX_STREAM_EXECUTOR_CUDA_COMMAND_BUFFER_KERNELS_H_
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_COMMAND_BUFFER_KERNELS_H_
