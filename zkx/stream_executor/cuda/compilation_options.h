...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_COMPILATION_OPTIONS_H_
#define ZKX_STREAM_EXECUTOR_CUDA_COMPILATION_OPTIONS_H_
...
struct CompilationOptions {
  ...
  // If true, compilation will fail if register spilling is detected and a
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_COMPILATION_OPTIONS_H_
