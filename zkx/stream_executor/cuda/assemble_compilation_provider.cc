...
#include "zkx/stream_executor/cuda/composite_compilation_provider.h"
#include "zkx/stream_executor/cuda/defer_relocatable_compilation_compilation_provider.h"
#include "zkx/stream_executor/cuda/nvjitlink_compilation_provider.h"
#include "zkx/stream_executor/cuda/nvjitlink_known_issues.h"
#include "zkx/stream_executor/cuda/nvjitlink_support.h"
#include "zkx/stream_executor/cuda/nvptxcompiler_compilation_provider.h"
#include "zkx/stream_executor/cuda/ptx_compiler_support.h"
#include "zkx/stream_executor/cuda/subprocess_compilation.h"
#include "zkx/stream_executor/cuda/subprocess_compilation_provider.h"
...
AssembleCompilationProvider(const CompilationProviderOptions& options) {
  ...
  if (parallel_compilation_support_is_desired && has_nvptxcompiler.ok() &&
    ...
    providers.reserve(2);
    providers.push_back(std::make_unique<NvptxcompilerCompilationProvider>());
    // TODO(chokobole): Uncomment this. Dependency: DriverCompilationProvider
  ...
  // Past this point we won't be able to support parallel compilation, so we
  ...
  return absl::UnavailableError(absl::StrCat(
      ...
      "`--zkx_gpu_unsafe_fallback_to_driver_on_ptxas_not_found`. Details: \n",
      decision_log));
}
