...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_CUBIN_OR_PTX_IMAGE_H_
#define ZKX_STREAM_EXECUTOR_CUDA_CUBIN_OR_PTX_IMAGE_H_
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_CUBIN_OR_PTX_IMAGE_H_
