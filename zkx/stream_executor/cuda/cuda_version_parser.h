...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_CUDA_VERSION_PARSER_H_
#define ZKX_STREAM_EXECUTOR_CUDA_CUDA_VERSION_PARSER_H_
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_CUDA_VERSION_PARSER_H_
