...
#ifndef ZKX_STREAM_EXECUTOR_CUDA_PTX_COMPILATION_METHOD_H_
#define ZKX_STREAM_EXECUTOR_CUDA_PTX_COMPILATION_METHOD_H_
...
#endif  // ZKX_STREAM_EXECUTOR_CUDA_PTX_COMPILATION_METHOD_H_
