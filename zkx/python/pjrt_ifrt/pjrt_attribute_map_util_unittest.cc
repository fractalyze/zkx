...
TEST(PjRtAttributeMapUtilTest, FromPjRtAttributeMap) {
  absl::flat_hash_map<std::string, PjRtValueType> pjrt_map({
      {"string", zkx::PjRtValueType(std::string("value"))},
      {"bool", zkx::PjRtValueType(true)},
      {"int64", zkx::PjRtValueType(int64_t{123})},
      {"int64_list",
       zkx::PjRtValueType(std::vector<int64_t>({int64_t{1}, int64_t{2}}))},
      {"float", zkx::PjRtValueType(1.23f)},
  });
