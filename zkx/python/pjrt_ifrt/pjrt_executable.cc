...
absl::StatusOr<const zkx::HloInstructionProto*> FindRootInstruction(
  ...
  return absl::InvalidArgumentError("Entry computation not found");
}
...
static absl::StatusOr<std::vector<zkx::Shape>> ResultShapesOfModule(
