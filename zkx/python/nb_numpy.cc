...
// static
nb_dtype nb_dtype::from_args(const nb::object& args) {
  PyArray_Descr* descr;
...
// static
nb_numpy_ndarray nb_numpy_ndarray::from_any(nanobind::handle h,
...
// static
nb_numpy_ndarray nb_numpy_ndarray::ensure(nanobind::handle h,
                                          int extra_requirements) {
  nb::handle out = PyArray_FromAny(
      h.ptr(), /*dtype=*/nullptr, /*min_depth=*/0,
      /*max_depth=*/0,
