...
#ifndef ZKX_PYTHON_SAFE_STATIC_INIT_H_
#define ZKX_PYTHON_SAFE_STATIC_INIT_H_
...
T& SafeStaticInit(F init_fn) {
  ...
  output.store(absl::IgnoreLeak(init_fn().release()));
  return *output.load();
}

}  // namespace zkx

#endif  // ZKX_PYTHON_SAFE_STATIC_INIT_H_
