...
#ifndef ZKX_PYTHON_NB_NUMPY_H_
#define ZKX_PYTHON_NB_NUMPY_H_
...
class nb_dtype : public nanobind::object {
 public:
  NB_OBJECT_DEFAULT(nb_dtype, object, "dtype", PyArray_DescrCheck);
...
class nb_numpy_ndarray : public nanobind::object {
 public:
  NB_OBJECT_DEFAULT(nb_numpy_ndarray, object, "ndarray", PyArray_Check);
