...
#ifndef ZKX_PYTHON_IFRT_ARRAY_H_
#define ZKX_PYTHON_IFRT_ARRAY_H_
...
class Array : public llvm::RTTIExtends<Array, Value> {
 public:
  ...
  virtual absl::StatusOr<std::shared_ptr<const zkx::PjRtLayout>> pjrt_layout()
      const = 0;
...
#endif  // ZKX_PYTHON_IFRT_ARRAY_H_
