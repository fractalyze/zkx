...
#ifndef ZKX_PYTHON_IFRT_MEMORY_H_
#define ZKX_PYTHON_IFRT_MEMORY_H_
...
class MemoryKind {
 public:
  ...
  explicit MemoryKind(std::optional<std::string_view> memory_kind);
  ...
  std::optional<std::string_view> memory_kind() const { return memory_kind_; }

 private:
  std::string ToString() const;

  std::optional<std::string_view> memory_kind_;
};
...
#endif  // ZKX_PYTHON_IFRT_MEMORY_H_
