...
#ifndef ZKX_PYTHON_IFRT_USER_CONTEXT_REGISTRY_H_
#define ZKX_PYTHON_IFRT_USER_CONTEXT_REGISTRY_H_
...
class TrackedUserContext {
 public:
  ...
  TrackedUserContext& operator=(const TrackedUserContext&) = delete;
  TrackedUserContext& operator=(TrackedUserContext&&) = delete;
...
#endif  // ZKX_PYTHON_IFRT_USER_CONTEXT_REGISTRY_H_
