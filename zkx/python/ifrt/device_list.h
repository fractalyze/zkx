...
#ifndef ZKX_PYTHON_IFRT_DEVICE_LIST_H_
#define ZKX_PYTHON_IFRT_DEVICE_LIST_H_
...
#include "zkx/python/ifrt/device.pb.h"
#include "zkx/python/ifrt/ref_wrapper.h"
...
class DeviceList : public tsl::ReferenceCounted<DeviceList>,
 ...
 public:
  ...
  static absl::StatusOr<RCReferenceWrapper<DeviceList>> FromProto(
      Client* client, const DeviceListProto& proto);
...
using DeviceListRef = RCReferenceWrapper<DeviceList>;
...
#endif  // ZKX_PYTHON_IFRT_DEVICE_LIST_H_
