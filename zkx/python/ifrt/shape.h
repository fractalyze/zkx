...
#ifndef ZKX_PYTHON_IFRT_SHAPE_H_
#define ZKX_PYTHON_IFRT_SHAPE_H_
...
#include "zkx/python/ifrt/shape.pb.h"
...
class DynamicShape {
 public:
  ...
  friend H AbslHashValue(H h, const DynamicShape& value) {
    return H::combine(std::move(h), value.shape_, value.tag_);
  }
...
#endif  // ZKX_PYTHON_IFRT_SHAPE_H_
