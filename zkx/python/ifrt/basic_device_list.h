...
#ifndef ZKX_PYTHON_IFRT_BASIC_DEVICE_LIST_H_
#define ZKX_PYTHON_IFRT_BASIC_DEVICE_LIST_H_
...
// implementation's own `DeviceList` constructed from its `zkx::ifrt::Client`
// API implementation.
//
...
#endif  // ZKX_PYTHON_IFRT_BASIC_DEVICE_LIST_H_
