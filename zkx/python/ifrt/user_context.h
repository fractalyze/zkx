...
#ifndef ZKX_PYTHON_IFRT_USER_CONTEXT_H_
#define ZKX_PYTHON_IFRT_USER_CONTEXT_H_
...
class AnnotatedUserContext
 ...
 public:
  ...
  AnnotatedUserContext(const AnnotatedUserContext&) = delete;
  AnnotatedUserContext& operator=(const AnnotatedUserContext&) = delete;
  AnnotatedUserContext(AnnotatedUserContext&&) = delete;
  AnnotatedUserContext& operator=(AnnotatedUserContext&&) = delete;
...
class ChainedUserContext
 ...
 public:
  ...
  ChainedUserContext(ChainedUserContext&&) = delete;
  ChainedUserContext& operator=(ChainedUserContext&&) = delete;
...
class FusedUserContext
 ...
 public:
  ...
  FusedUserContext(FusedUserContext&&) = delete;
  FusedUserContext& operator=(FusedUserContext&&) = delete;
...
#endif  // ZKX_PYTHON_IFRT_USER_CONTEXT_H_
