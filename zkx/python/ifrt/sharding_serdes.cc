...
#include "zkx/python/ifrt/ir/sharding_param.h"
...
#include "zkx/python/ifrt/sharding_serdes.pb.h"
...
class SingleDeviceShardingSerDes
 ...
 public:
  std::string_view type_name() const override {
    return "zkx::ifrt::SingleDeviceSharding";
  }
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    if (!proto.ParseFromString(serialized)) {
      return absl::InvalidArgumentError(
          "Failed to parse serialized SingleDeviceSharding");
    }
...
class OpaqueShardingSerDes
 ...
 public:
  std::string_view type_name() const override {
    return "zkx::ifrt::OpaqueSharding";
  }
...
class ConcreteShardingSerDes
 ...
 public:
  std::string_view type_name() const override {
    return "zkx::ifrt::ConcreteSharding";
  }
...
class ConcreteEvenShardingSerDes
 ...
 public:
  std::string_view type_name() const override {
    return "zkx::ifrt::ConcreteEvenSharding";
  }
...
class ShardingParamShardingSerDes
 ...
 public:
  std::string_view type_name() const override {
    return "zkx::ifrt::ShardingParamSharding";
  }
...
[[maybe_unused]] char ShardingParamShardingSerDes::ID = 0;
