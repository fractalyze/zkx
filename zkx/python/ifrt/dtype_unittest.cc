...
TEST(DTypeTest, ByteSize) {
  for (const auto& [kind, byte_size] :
       std::vector<std::tuple<DType::Kind, int>>({
           ...
           {DType::kKoalabear4, 16},
           {DType::kKoalabear4Std, 16},
           {DType::kBabybear, 4},
           {DType::kBabybearStd, 4},
           {DType::kBabybear4, 16},
           {DType::kBabybear4Std, 16},
           {DType::kMersenne31, 4},
           {DType::kMersenne31Std, 4},
           {DType::kGoldilocks, 8},
           {DType::kGoldilocksStd, 8},
           {DType::kGoldilocks3, 24},
           {DType::kGoldilocks3Std, 24},
           {DType::kBn254Sf, 32},
...
TEST(DTypeTest, BitSize) {
  for (const auto& [kind, bit_size] :
       std::vector<std::tuple<DType::Kind, int>>({
           ...
           {DType::kKoalabear4, 128},
           {DType::kKoalabear4Std, 128},
           {DType::kBabybear, 32},
           {DType::kBabybearStd, 32},
           {DType::kBabybear4, 128},
           {DType::kBabybear4Std, 128},
           {DType::kMersenne31, 32},
           {DType::kMersenne31Std, 32},
           {DType::kGoldilocks, 64},
           {DType::kGoldilocksStd, 64},
           {DType::kGoldilocks3, 192},
           {DType::kGoldilocks3Std, 192},
           {DType::kBn254Sf, 256},
