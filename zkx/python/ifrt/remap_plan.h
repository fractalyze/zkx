...
#ifndef ZKX_PYTHON_IFRT_REMAP_PLAN_H_
#define ZKX_PYTHON_IFRT_REMAP_PLAN_H_
...
#include "zkx/python/ifrt/remap_plan.pb.h"
...
struct RemapPlan {
  ...
  absl::Status CheckArrayCopySemantics(ArrayCopySemantics semantics) const;
};

}  // namespace zkx::ifrt

#endif  // ZKX_PYTHON_IFRT_REMAP_PLAN_H_
