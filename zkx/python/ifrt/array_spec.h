...
#ifndef ZKX_PYTHON_IFRT_ARRAY_SPEC_H_
#define ZKX_PYTHON_IFRT_ARRAY_SPEC_H_
...
#include "zkx/python/ifrt/array_spec.pb.h"
...
struct ArraySpec {
  ...
  absl_nullable std::shared_ptr<const zkx::PjRtLayout> layout;
...
#endif  // ZKX_PYTHON_IFRT_ARRAY_SPEC_H_
