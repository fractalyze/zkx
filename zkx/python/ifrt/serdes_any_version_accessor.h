...
#ifndef ZKX_PYTHON_IFRT_SERDES_ANY_VERSION_ACCESSOR_H_
#define ZKX_PYTHON_IFRT_SERDES_ANY_VERSION_ACCESSOR_H_
...
#endif  // ZKX_PYTHON_IFRT_SERDES_ANY_VERSION_ACCESSOR_H_
