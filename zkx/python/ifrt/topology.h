...
#ifndef ZKX_PYTHON_IFRT_TOPOLOGY_H_
#define ZKX_PYTHON_IFRT_TOPOLOGY_H_
...
class Topology : public llvm::RTTIExtends<Topology, llvm::RTTIRoot> {
 public:
  ...
  virtual absl::StatusOr<zkx::Layout> GetDefaultLayout(
...
#endif  // ZKX_PYTHON_IFRT_TOPOLOGY_H_
