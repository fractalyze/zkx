...
#ifndef ZKX_PYTHON_IFRT_SERDES_DEFAULT_VERSION_ACCESSOR_H_
#define ZKX_PYTHON_IFRT_SERDES_DEFAULT_VERSION_ACCESSOR_H_
...
#endif  // ZKX_PYTHON_IFRT_SERDES_DEFAULT_VERSION_ACCESSOR_H_
