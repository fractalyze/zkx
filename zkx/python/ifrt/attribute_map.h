...
#ifndef ZKX_PYTHON_IFRT_ATTRIBUTE_MAP_H_
#define ZKX_PYTHON_IFRT_ATTRIBUTE_MAP_H_
...
class AttributeMap {
 public:
  ...
  // `zkx::PjRtValueType`, but they add a layer of structs that prevent implicit
...
#endif  // ZKX_PYTHON_IFRT_ATTRIBUTE_MAP_H_
