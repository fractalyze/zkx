...
#ifndef ZKX_PYTHON_IFRT_REF_WRAPPER_H_
#define ZKX_PYTHON_IFRT_REF_WRAPPER_H_
...
class RCReferenceWrapper {
 public:
  ...
  template <typename U>
  RCReferenceWrapper(const RCReferenceWrapper<U>& ref) : ref_(ref.ref_) {}
  template <typename U>
  RCReferenceWrapper(RCReferenceWrapper<U>&& ref) noexcept
...
#endif  // ZKX_PYTHON_IFRT_REF_WRAPPER_H_
