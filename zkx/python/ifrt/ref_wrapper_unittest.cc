...
class DerivedClass : public BaseClass {
 public:
  explicit DerivedClass(std::string_view name) : name_(name) {}
...
using BaseClassRef = ::zkx::ifrt::RCReferenceWrapper<BaseClass>;
using DerivedClassRef = ::zkx::ifrt::RCReferenceWrapper<DerivedClass>;
