...
#ifndef ZKX_PYTHON_IFRT_SHARDING_H_
#define ZKX_PYTHON_IFRT_SHARDING_H_
...
#include "zkx/python/ifrt/sharding.pb.h"
...
enum class SingleDeviceShardSemantics : int {
  // Processes only the single-device shards on addressable devices.
  //
...
// TODO(hyeontaek): Move the subclasses of `Sharding` to a separate file,
...
#endif  // ZKX_PYTHON_IFRT_SHARDING_H_
