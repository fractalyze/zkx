...
#ifndef ZKX_RUNTIME_BUFFER_USE_H_
#define ZKX_RUNTIME_BUFFER_USE_H_
...
// BufferUse tracks memory access type for a buffer slice, so that ZKX can
...
#endif  // ZKX_RUNTIME_BUFFER_USE_H_
