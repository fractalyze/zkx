#ifndef ZKX_MATH_ELLIPTIC_CURVE_SHORT_WEIERSTRASS_SW_CURVE_H_
#define ZKX_MATH_ELLIPTIC_CURVE_SHORT_WEIERSTRASS_SW_CURVE_H_
...
#endif  // ZKX_MATH_ELLIPTIC_CURVE_SHORT_WEIERSTRASS_SW_CURVE_H_
